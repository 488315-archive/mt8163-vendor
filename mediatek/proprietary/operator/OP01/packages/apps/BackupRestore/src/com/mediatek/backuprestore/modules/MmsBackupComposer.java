            ...
            if (mMmsCursorArray[i] != null && !mMmsCursorArray[i].isAfterLast()) {
                ...
                try {
                    ...
                    if (pduMid != null) {
                        ...
                        // long subId =
                        // mMmsCursorArray[i].getLong(mMmsCursorArray[i]
                        //.getColumnIndex(COLUMN_NAME_SUBID));
                        MyLogger.logD(CLASS_TAG, "Get subId From Mms_db :" + subId);
                        String slotId = "0";
                        if ((TelephonyManager.getDefault().getPhoneCount() == 2) && subId >= 0) {
                            ...
                            if (simInfo != null) {
                                ...
                                MyLogger.logD(CLASS_TAG,
                                        "WARMING : simInfo is null and stop backup MMS");
                            }
        ...
        if (mXmlComposer != null) {
            ...
            if (getComposed() > 0 && msgXmlInfo != null) {
                ...
                writeToFile(mParentFolderPath + File.separator + ModulePath.FOLDER_MMS
                        + File.separator + ModulePath.MMS_XML, msgXmlInfo.getBytes());
