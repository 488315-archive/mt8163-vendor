...
public class SmsBackupComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        for (int i = 0; i < mSmsCursorArray.length; ++i) {
            if (mSmsCursorArray[i] != null && !mSmsCursorArray[i].isAfterLast()) {
                ...
                boolean isGemini = TelephonyManager.getDefault().getPhoneCount() == 2;
                String mSlotid = "0";
                if (isGemini && subid >= 0) {
                ...
                MyLogger.logE(CLASS_TAG, "combineVmsg:timeStamp=" + timeStamp + ",readByte="
                        + readByte + ",locked =" + locked + ",body =" + body);
                try {
                    if (mWriter != null) {
    ...
    private String combineVmsg(String timeStamp, String readByte, String boxType, String mSlotid,
            String locked, String smsAddress, String body, String mseen) {
