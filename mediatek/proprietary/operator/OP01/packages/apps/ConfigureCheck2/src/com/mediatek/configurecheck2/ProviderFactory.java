...
final class CheckItemKeySet {
   ...
   // public static final String CI_MODEM_SWITCH_SGLTE = "ModemSwitchSglte";
    ...
    //mtbf manul
    public static final String CI_MTBF_INPUTMETHOD = "mtbfinput";
    public static final String CI_MTBF_DUALSIM = "mtbfdualsim";
    public static final String CI_MTBF_WEBFONT = "mtbfwebfont";
    public static final String CI_MTBF_LOGGER = "mtbflogger";
    public static final String CI_MTBF_MMS_SETTING = "mtbfmmssetting";
    public static final String CI_MTBF_EMAIL_SETTING = "mtbfemailsetting";
    public static final String CI_MTBF_STORAGE = "mtbfdefaultstorage";
}
