...
class MTKMTBFProvider extends CheckItemProviderBase {
    MTKMTBFProvider(Context c) {
        ...
        // mArrayItems.add(new CheckDefaultStorage(c, CheckItemKeySet.CI_DEFAULTSTORAGE));
         ...
         mArrayItems.add(new CheckDefaultIME(c, CheckItemKeySet.CI_MTBF_INPUTMETHOD));
         mArrayItems.add(new CheckDualSIMAsk(c, CheckItemKeySet.CI_MTBF_DUALSIM));
         mArrayItems.add(new CheckWebFont(c, CheckItemKeySet.CI_MTBF_WEBFONT));
         mArrayItems.add(new CheckLogger(c, CheckItemKeySet.CI_MTBF_LOGGER));
         //mArrayItems.add(new CheckRedScreenOff(c, CheckItemKeySet.CI_MANUL_CHECK));
         mArrayItems.add(new CheckMMSSetting(c, CheckItemKeySet.CI_MTBF_MMS_SETTING));
         mArrayItems.add(new CheckEmailSetting(c, CheckItemKeySet.CI_MTBF_EMAIL_SETTING));
         mArrayItems.add(new CheckDefaultStorageSetting(c, CheckItemKeySet.CI_MTBF_STORAGE));
