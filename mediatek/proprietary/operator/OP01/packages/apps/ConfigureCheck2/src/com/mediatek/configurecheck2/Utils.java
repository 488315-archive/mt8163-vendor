...
public class Utils {
    ...
    public static final boolean IS_C2K_SUPPORT =
            SystemProperties.get("ro.mtk_c2k_support").equals("1");

    public static final boolean IS_3_MODEMS = (WorldPhoneUtil.isWorldPhoneSupport() == false);
    public static final boolean IS_5_MODEMS = WorldPhoneUtil.isWorldPhoneSupport();
    ...
    public static final boolean IS_6_MODEMS =  IS_5_MODEMS && IS_C2K_SUPPORT;
}
