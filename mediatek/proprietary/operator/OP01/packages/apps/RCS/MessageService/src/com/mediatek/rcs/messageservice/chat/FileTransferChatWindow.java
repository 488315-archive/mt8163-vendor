...
public class FileTransferChatWindow {
    ...
    public long updateFileTansferTag(String newFileTransferTag, String oldFileTransferTag) {
    ...
    public void updateFileTansferTag(String newFileTransferTag) {
        Log.d(TAG, "updateFilePath enter, newFileTransferTag = "
                                  + newFileTransferTag);
        mFileTransferTag = newFileTransferTag;
    }

    public void updateFilePath(String filePath) {
        Log.d(TAG, "updateFilePath enter, filePath = " + filePath);
        mFileTransfer.mFilePath = filePath;
    ...
    private void deleteBurnedMsg() {
        Log.d(TAG, " drawDeleteBARMsgIndicator deleteBurnedMsg() ft ");
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    Thread.sleep(5100);
                    RCSDataBaseUtils.deleteBurnMessage(mService.getContext(), mFileTransferTag,
                            Direction.OUTGOING);
