...
public class CloudMsgBackupRestore {
    ...
    private AlertDialog mCancelConfirmDlg = null;
        ...
        public void onServiceConnected(final ComponentName name, final IBinder service) {
            ...
            if (mBackupBinder != null) {
                if (mHandler != null) {
                    ...
                    mBackupBinder.setContext(ContextCacher.getHostContext());
        ...
        public void onServiceConnected(final ComponentName name, final IBinder service) {
            ...
            if (mRestoreBinder != null) {
                if (mHandler != null) {
                    ...
                    mRestoreBinder.setContext(ContextCacher.getHostContext());
    ...
    private void createCancelDialog() {
        ...
        Builder builder = new AlertDialog.Builder(mUiContext)
                ...
                mCancelConfirmDlg = builder.create();
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(final Message msg) {
                ...
                case CloudBrUtils.MessageID.RESTORE_END:
                    ...
                    if (mCancelConfirmDlg != null) {
                        if (mCancelConfirmDlg.isShowing()) {
                            mCancelConfirmDlg.dismiss();
                            mIsCancel = false;
                        }
                        mCancelConfirmDlg = null;
                    }
