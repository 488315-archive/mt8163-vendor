...
/**
 * IpImageMessage is a RCS file transfer image message. App can get Image thumbnail file by
 * {@link #getThumbPath()} and get the image file path by {@link #getPath()}. App can also get the
 * image's size by {@link #getSize()}
 *
 */
...
//        mFileName = fileStruct.mName;
    ...
    public IpImageMessage() {
        super(IpMessageConsts.IpMessageType.PICTURE);
    }
...
//    }
     ...
     * @return the thumbnail file path, it maybe null or empty string.
     */
