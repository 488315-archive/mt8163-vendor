...
public class RcsSettingListActivity extends DefaultIpSettingListActivityExt {
    ...
    public boolean onIpListItemClick(int position) {
        ...
        if (mIsWithIpMsg) {
            ...
            switch (position) {
            case 1: //sms
                intent.setClassName(mHostActivity,
                                    "com.mediatek.setting.SmsPreferenceActivity");
                mHostActivity.startActivity(intent);
                return true;
            case 2: //mms
                intent.setClassName(mHostActivity, "com.mediatek.setting.MmsPreferenceActivity");
                mHostActivity.startActivity(intent);
                return true;
            case 3: //rcs
            ...
            case 4: //notification
                intent.setClassName(mHostActivity,
                                "com.mediatek.setting.NotificationPreferenceActivity");
                mHostActivity.startActivity(intent);
                return true;
            case 5: //general
                intent.setClassName(mHostActivity,
                                    "com.mediatek.setting.GeneralPreferenceActivity");
                mHostActivity.startActivity(intent);
                return true;
            default:
                break;
