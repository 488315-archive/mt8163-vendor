...
/**
 * IpVideoMessage is a RCS file transfer message with a video. App can get the video's duration by
 * {@link #getDuration()}, can get thumbnail path by {@link #getThumbPath()}.
 *
 */
...
//    private String mFileName;
    ...
    public IpVideoMessage(FileStruct fileStruct, String remote) {
        super(IpMessageConsts.IpMessageType.VIDEO);
...
//    }
    ...
    /**
     * Get thumbnail file's full path.it will return null or empty string if the thumbnail is not
     * exist.
     * @return thumbnail file's full path with dir
     */
    ...
    /**
     * Set thumbnail path.
     * @param thumbPath thumbnail file's full path
     */
