...
/**
 * To avoid query database frequently, use this cache to get better performance.
 * This cache stores group chat info, format as {@link GroupChatInfo}, and can find
 * by group unique id, chat id.
 */
public class GroupChatCache {
    ...
    /**
     * Init this cache, It must be called before it is used.
    ...
    /**
     * Get GroupChatInfo by its chatId
     * @param chatId Unique id of this group
    ...
    /**
     * Update subId of this Group chat.
     * @param chatId Unique id of this group
     * @param subId target subId
     */
    ...
    /**
     * Update status of this Group chat.
     * @param chatId Unique id of this group
    ...
    /**
     * Update nickname of this Group chat.
     * @param chatId Unique id of this group
    ...
    /**
     * Update isMeChairmen of this Group chat.
     * @param chatId Unique id of this group
     * @param isMeChairmen target isMeChairmen
     */
     ...
     * Add GroupChatInfo.
     * @param chatId Unique id of this group
     * @param subject Subject of this group
     * @param status Status of this group
     * @param isMeChairmen IsMeChairmen of this group
     */
    ...
    private void refreshByThreadsAfterDelete() {
