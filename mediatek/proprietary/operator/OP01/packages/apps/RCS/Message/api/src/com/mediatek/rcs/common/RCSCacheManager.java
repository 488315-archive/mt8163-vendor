...
/**
 * RCSCacheManager, it manage the cache of RCS FT message. In {@link #RCSMessageManager}
 * it will get FT ip message instance through function {@link #getFTMessageInfo()}.
 * We will get FT ipMessage from cache, if it not in it, we will get it from DB.
 */
public class RCSCacheManager{
    ...
    /**
     * getIpMessage through ipmsgId fromsCachedSendMessage .
     * @param ipmsgId.
     * @return return ipmsg if get it from cache, or return null.
     */
    ...
    /**
     * set IpMessage into cache, the cache is a Map {@link #sCachedSendMessage} .
     * @param ipMsg  the ipMsg object
     * @param ipmsgId the ipmsgId of the ipMsg
     */
    ...
    /**
     * update ipmsg status.
     * @param ipmsgId ipmsgId of the ipMsg in cache
     * @param rcsStatus reference {@link #MessageStatusUtils}
     * @param smsStatus reference {@link #MessageStatusUtils}
     */
    ...
    /**
     * When download a file successfully, the function will be called to
     * set file path
     * @param ipmsgId   ipmsgId of the ipMsg in cache
    ...
    /**
     * Remove IpMessage from cache through ipmsgId.
     * @param ipmsgId  ipmsgId of the ipMsg in cache
     */
    ...
    /**
     * Clear the cache, remove all contents in cache.
     */
