...
/**
 * IpGeolocMessage is geolocation message. Its latitude and longitude are saved in the file in xml.
 * To get the latitude and longitude, app need to parse the xml content in file that can be got by
 * {@link #getPath()}.
 *
 */
...
//    private String mName;
    ...
    public IpGeolocMessage(FileStruct fileStruct, String remote) {
        super(IpMessageConsts.IpMessageType.GEOLOC);
