...
public class CallStatusController {
    ...
    public static final int PHONE_STATE_NEW = 0;
    public static final int PHONE_STATE_DIALING = 1;
    public static final int PHONE_STATE_RINGING = 2;
    public static final int PHONE_STATE_HOLDING = 3;
    public static final int PHONE_STATE_ACTIVE = 4;
    public static final int PHONE_STATE_DISCONNECTED = 7;
    public static final int PHONE_STATE_PRE_DIAL_WAIT = 8;
    public static final int PHONE_STATE_CONNECTING = 9;
    public static final int PHONE_STATE_DISCONNECTING = 10;
    ...
    public Call onMenuItemSelected() {
        ...
        if (!TextUtils.isEmpty(mCurrentCallId)) {
            currCall = getCallById(mCurrentCallId);
        }

        if (currCall == null) {
            currCall = getConnectingCall();
        }
    ...
    public boolean isNeedShowMenuItem() {
        ...
        if (currCall != null) {
            ...
            if (currCall.getState() == PHONE_STATE_RINGING) {
                return false;
            }
    ...
    private Call getCurrentCall() {
        ...
        if (call == null || PhoneUtils.isVideoCall(call, mContext)) {
            return null;
        }
        return call;
    }
    ...
    private Call getActiveCall() {
        for (Call call : mCallMap.values()) {
            if (call != null && call.getState() == PHONE_STATE_ACTIVE) {
                return call;
            }
        }
        return null;
    ...
    private Call getDisconnectCall() {
        for (Call call : mCallMap.values()) {
            if (call != null) {
                if (call.getState() == PHONE_STATE_DISCONNECTING ||
                    call.getState() == PHONE_STATE_DISCONNECTED) {
                    return call;
                }
            }
        }
    ...
    private Call getHoldingCall() {
        for (Call call : mCallMap.values()) {
            if (call != null && call.getState() == PHONE_STATE_HOLDING) {
                return call;
            }
        }
        return null;
    ...
    private Call getConnectingCall() {
        for (Call call : mCallMap.values()) {
            if (call != null && call.getState() == PHONE_STATE_CONNECTING) {
                return call;
            }
        }
        return null;
    ...
    private Call getDialingCall() {
        for (Call call : mCallMap.values()) {
            if (call != null && call.getState() == PHONE_STATE_DIALING) {
                return call;
            }
        }
        return null;
    ...
    private Call getRingingCall() {
        for (Call call : mCallMap.values()) {
            if (call != null && call.getState() == PHONE_STATE_RINGING) {
                return call;
            }
        }
        return null;
    ...
    public void onCallStatusChange(Call callItem, HashMap<String, Call> callMap) {
        mCallMap = callMap;
    ...
    private void updateStatusMap() {
        for (Call call : mCallMap.values()) {
            ...
            switch (call.getState()) {
                case PHONE_STATE_NEW:
                case PHONE_STATE_DIALING:
                case PHONE_STATE_CONNECTING:
                case PHONE_STATE_PRE_DIAL_WAIT:
                ...
                case PHONE_STATE_RINGING:
                    ...
                    break;
                case PHONE_STATE_ACTIVE:
                    Integer statusInteger = mStatusMap.get(call.getCallId());
                    ...
                    break;
                case PHONE_STATE_DISCONNECTED:
                    statusInteger = mStatusMap.get(call.getCallId());
                    if (statusInteger == null) {
                        if (PhoneUtils.isVideoCall(call, mContext)) {
