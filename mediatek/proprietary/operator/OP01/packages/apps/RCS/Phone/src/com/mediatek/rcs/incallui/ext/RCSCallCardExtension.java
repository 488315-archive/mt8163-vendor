...
public class RCSCallCardExtension extends DefaultRCSeCallCardExt {
    ...
    public void onImageLoaded(String callId, Object entry) {
        ...
        refrehInstance(false);
        if (mRCSInCallUIPlugin == null || !mRCSInCallUIPlugin.isRCSEnable()) {
            return;
        }
        ...
        if (inCallCall == null || contactEntry == null || photo == null) {
            return;
        }
        ...
        Drawable clone = photo.getConstantState().newDrawable();
        mRCSInCallUIPlugin.putDrawable(uriString, clone);
