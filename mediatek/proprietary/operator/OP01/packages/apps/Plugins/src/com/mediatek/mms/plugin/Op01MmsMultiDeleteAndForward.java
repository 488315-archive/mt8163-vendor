...
//    private MenuItem item = null;
    ...
    public void setBodyandAddress(Cursor cursor, IColumnsMapCallback columnsMap) {
        try {
            String type = cursor.getString(columnsMap.getColumnMsgType());
            Log.d(TAG, "setBodyandAddress type = " + type);
            if (type.equals("sms")) {
                ...
                Log.d(TAG, "initListMap mAddress = " + address + "mBody" + body +
                    ", boxid = " + boxType);
                BodyandAddress  ba = new BodyandAddress(address, body, boxType);
