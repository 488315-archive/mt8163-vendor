...
public class OP07NetworkSettingExt extends DefaultNetworkSettingExt {
    ...
    private static final String OP07_BUTTTON_MANUAL_FEMTOCELL = "op07_button_manual_femtocell";
    ...
    public void initOtherNetworkSetting(PreferenceScreen prefSet) {
        ...
        Log.d(TAG, "initOtherNetworkSetting");
        Preference femtopref = prefSet.findPreference(BUTTTON_MANUAL_FEMTOCELL);
        if (femtopref != null) {
            prefSet.removePreference(femtopref);
        }
        Preference microcell = new ManualFemtoCellSelection(mContext, prefSet);
        microcell.setKey(OP07_BUTTTON_MANUAL_FEMTOCELL);
        microcell.setTitle(mContext.getString(R.string.search_femtocell_list));
        microcell.setPersistent(false);
        prefSet.addPreference(microcell);
        Log.d(TAG, "initOtherNetworkSetting op07 preference added");
    }

   @Override
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
         Log.d(TAG, "onPreferenceTreeClick op07");
         Preference femtopref = preferenceScreen.findPreference(OP07_BUTTTON_MANUAL_FEMTOCELL);
