...
public class Op05DatabaseHelperExt extends DefaultDatabaseHelperExt {

    private static final String TAG = "Op05DatabaseHelperExt";
    /**
     * @param context Context
     * constructor
     */
    public Op05DatabaseHelperExt(Context context) {
         super(context);
    }
