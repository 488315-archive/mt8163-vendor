...
/**
 * Customization from OP09A for data when roaming.
 * Popup reminder dialog when roaming first time.
 */
public class DataRoamingCustomizationOP09 extends DataRoamingCustomization {
    protected static final String TAG = "DataRoamingCustomizationOP09A";

    /**
     * Construct DataRoamingCustomization with context and phone.
     * @param phoneProxy PhoneProxy
     */
    public DataRoamingCustomizationOP09(PhoneProxy phoneProxy) {
        super(phoneProxy);
    }
    ...
    protected void checkFirstRoaming() {
        ...
        if (userDataEnabled && isRoaming && firstRoaming) {
            popupDialog();
