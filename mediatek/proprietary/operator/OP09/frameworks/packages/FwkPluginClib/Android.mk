...
LOCAL_SRC_FILES += $(call all-java-files-under, ../../../../common/frameworks/java/com/mediatek/op/telephony/DataRoamingCustomization.java)

LOCAL_PACKAGE_NAME :=  FwkPluginClib
