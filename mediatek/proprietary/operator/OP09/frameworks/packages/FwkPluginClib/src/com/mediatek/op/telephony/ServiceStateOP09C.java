...
public class ServiceStateOP09C extends DefaultServiceStateExt {

    private static final String TAG = "ServiceStateOP09C";
    ...
    public boolean isRoamingForSpecialSIM(String strServingPlmn, String strHomePlmn) {
        if (strServingPlmn != null && !strServingPlmn.startsWith("460")) {
            if ("45403".equals(strHomePlmn) || "45404".equals(strHomePlmn)) {
                Log.d(TAG, "special SIM, force roaming. IMSI:" + strHomePlmn);
                return true;
            }
        }
        return false;
