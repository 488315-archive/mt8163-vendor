...
/**
 * TelephonyExt OP09C plugin.
 *
 */
@PluginImpl(interfaceName = "com.mediatek.common.telephony.ITelephonyExt")
public class TelephonyExtOP09C extends TelephonyExt {
    private static final String TAG = "TelephonyExtOP09C";
    ...
    public void startDataRoamingStrategy(Object phoneProxy) {
        ...
        mDataRoamingCustomization = new DataRoamingCustomizationOP09C(
