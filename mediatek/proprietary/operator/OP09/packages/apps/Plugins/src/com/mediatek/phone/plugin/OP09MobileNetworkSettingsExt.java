...
import com.mediatek.settings.plugin.ChangeNetworkType;
...
public class OP09MobileNetworkSettingsExt extends DefaultMobileNetworkSettingsExt {
        ...
        if (null != (PreferenceScreen) preferenceScreen.findPreference(CT_APN_KEY)
            ...
            try {
                ...
                Settings.Global.putInt(mOP09Context.getContentResolver(),
                        ...
                        (isChecked ? Phone.NT_MODE_LTE_TDD_ONLY
    ...
    private void switchSvlteRatMode(boolean isChecked) throws RemoteException {
        ...
        if (null != telephony) {
            /*
            telephony.setPreferredNetworkType(subId, (isChecked ?
                  Phone.NT_MODE_LTE_CDMA_AND_EVDO :
                  (Phone.NT_MODE_CDMA_NO_EVDO
                   | Phone.NT_MODE_CDMA
                   | Phone.NT_MODE_LTE_CDMA_AND_EVDO)));
            */
            int networkType = (isChecked ? Phone.NT_MODE_LTE_CDMA_AND_EVDO :
                    (Phone.NT_MODE_CDMA_NO_EVDO
                    | Phone.NT_MODE_CDMA
                    | Phone.NT_MODE_LTE_CDMA_AND_EVDO));
    ...
    */
    ...
    public void initOtherMobileNetworkSettings(PreferenceActivity activity, int subId) {
        ...
        if (!mIsRegister) {
            ...
            int subscriptionId = SubscriptionManager.getSubIdUsingPhoneId(PhoneConstants.SIM_ID_1);
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                CardType cardType = mTelephonyManagerEx.getCdmaCardType(PhoneConstants.SIM_ID_1);
    ...
    private void updateSwitch() {
        if (mSwitchPreference != null) {
            ...
            mSwitchPreference.setChecked(
                    patternLteDataOnly == Phone.NT_MODE_LTE_TDD_ONLY);
            ...
            boolean roamingEnable  = !mTelephonyManagerEx.isInHomeNetwork(subId);
            ...
            if ((simInserted && !isAirPlaneMode() && mIsLteCardType
                ...
                && (patternLteDataOnly != Phone.NT_MODE_CDMA)
