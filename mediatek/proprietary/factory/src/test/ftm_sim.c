...
/*Adapt SVLTE/SRLTE, really need to refine, OMG, 2015/07/07 {*/
#if defined(MTK_FTM_SRLTE_SUPPORT) || defined(MTK_FTM_SVLTE_SUPPORT)
    #define MTK_FTM_REMOTE_SIM
#else
    #undef MTK_FTM_REMOTE_SIM
#endif
/*Adapt SVLTE/SRLTE, really need to refine, OMG, 2015/07/07 }*/
