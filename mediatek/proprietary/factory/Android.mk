...
LOCAL_SHARED_LIBRARIES:= libc libcutils libnvram libdl libhwm libaudiocustparam libext4_utils libfile_op libcustom_nvram libpixelflinger
...
ifeq ($(MTK_SRLTE_SUPPORT), yes)
LOCAL_CFLAGS += -DMTK_FTM_SRLTE_SUPPORT
$(warning MTK_FTM_SRLTE_SUPPORT=yes)
endif
