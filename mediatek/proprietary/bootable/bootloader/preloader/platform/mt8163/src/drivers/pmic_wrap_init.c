...
S32 pwrap_init ( void )
{
  ...
  //###############################
  mt_set_gpio_mode(GPIO1 | 0x80000000, GPIO_MODE_01);  // MI
  mt_set_gpio_mode(GPIO0 | 0x80000000, GPIO_MODE_01);  // MO
  mt_set_gpio_mode(GPIO3 | 0x80000000, GPIO_MODE_01);  // CK
  mt_set_gpio_mode(GPIO4 | 0x80000000, GPIO_MODE_01);  // CS
