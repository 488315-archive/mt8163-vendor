...
#define         EMI_MPUA2               (( P_U32)(EMI_BASE+0x260))              /* Memory protection unit control registers A */
#define         EMI_MPUB2               (( P_U32)(EMI_BASE+0x268))              /* Memory protection unit control registers B */
#define         EMI_MPUC2               (( P_U32)(EMI_BASE+0x270))              /* Memory protection unit control registers C */
#define         EMI_MPUD2               (( P_U32)(EMI_BASE+0x278))              /* Memory protection unit control registers D */
#define         EMI_MPUE2               (( P_U32)(EMI_BASE+0x280))              /* Memory protection unit control registers E */
#define         EMI_MPUF2               (( P_U32)(EMI_BASE+0x288))              /* Memory protection unit control registers F */
#define         EMI_MPUG2               (( P_U32)(EMI_BASE+0x290))              /* Memory protection unit control registers G */
#define         EMI_MPUH2               (( P_U32)(EMI_BASE+0x298))              /* Memory protection unit control registers H */
