...
#define ARMPLL_CON0             (APMIXED_BASE + 0x210)
#define ARMPLL_CON1             (APMIXED_BASE + 0x214)
#define ARMPLL_CON2             (APMIXED_BASE + 0x218)
#define ARMPLL_PWR_CON0         (APMIXED_BASE + 0x21C)
...
#define AUD1PLL_CON0            (APMIXED_BASE + 0x2A0)
#define AUD1PLL_CON1            (APMIXED_BASE + 0x2A4)
#define AUD1PLL_CON2            (APMIXED_BASE + 0x2A8)
#define AUD1PLL_CON3            (APMIXED_BASE + 0x300)
#define AUD1PLL_PWR_CON0        (APMIXED_BASE + 0x2AC)

#define AUD2PLL_CON0            (APMIXED_BASE + 0x2B0)
#define AUD2PLL_CON1            (APMIXED_BASE + 0x2B4)
#define AUD2PLL_CON2            (APMIXED_BASE + 0x2B8)
#define AUD2PLL_CON3            (APMIXED_BASE + 0x304)
#define AUD2PLL_PWR_CON0        (APMIXED_BASE + 0x2BC)
...
#define LVDSPLL_CON0            (APMIXED_BASE + 0x2C0)
#define LVDSPLL_CON1            (APMIXED_BASE + 0x2C4)
#define LVDSPLL_CON2            (APMIXED_BASE + 0x2C8)
#define LVDSPLL_PWR_CON0        (APMIXED_BASE + 0x2CC)
...
#define CLK_CFG_UPDATE_1        (CKSYS_BASE + 0x008)
...
enum {
    ...
    //#define MEMPLL_CLK_666
#elif defined(DDR_1500)
    #define DDR_MEMPLL DDR1500
#elif defined(DDR_1600)
    #define DDR_MEMPLL DDR1600  
    //#define MEMPLL_CLK_800
#else
    #define DDR_MEMPLL DDR533
    //#define MEMPLL_CLK_266
#endif
...
//#define DRAMC_ASYNC //open whem 1PLL Async mode or 2PLL Async mode

//#define BYPASS_MEMPLL1

//#define DDRPHY_3PLL_MODE  //mark  DDRPHY_3PLL_MODE to 1 PLL and enable DRAMC_ASYNC

#define DDRY2PLL_SYNC_MODE   //open DDRPHY_3PLL_MODE

//#define DDRY2PLL_ASYNC_MODE  //open DDRPHY_3PLL_MODE & enable DRAMC_ASYNC

//#define ACD_TEST_MODE //only for 3Pll 2Pll CLK_666 , 5MHz BW

//#define ACD_TEST_MODE_1600 // only for CLK_793, 5MHz BW

//#define MEMPLL_CLK_733MHZ //base on 3PLL sync mode  MEMPLL_CLK_666   ACD_TEST_MODE
