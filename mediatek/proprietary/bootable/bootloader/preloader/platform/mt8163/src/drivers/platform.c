...
void platform_pmic_full_reset_enable(void)
{
    ...
    pmic_config_interface(TOP_RST_MISC_SET, 0x0002, 0xFFFF, 0); //[1]=1, RG_WDTRSTB_MODE
    pmic_config_interface(TOP_RST_MISC_SET, 0x0001, 0xFFFF, 0); //[0]=1, RG_WDTRSTB_EN
    print("[Reg check][0x%x]=0x%x\n", TOP_RST_MISC, upmu_get_reg_value(TOP_RST_MISC));
#endif
}
...
void platform_pmic_full_reset_disable(void)
{
    ...
    pmic_config_interface(TOP_RST_MISC_CLR, 0x0002, 0xFFFF, 0); //[1]=0, RG_WDTRSTB_MODE
    pmic_config_interface(TOP_RST_MISC_SET, 0x0001, 0xFFFF, 0); //[0]=1, RG_WDTRSTB_EN
