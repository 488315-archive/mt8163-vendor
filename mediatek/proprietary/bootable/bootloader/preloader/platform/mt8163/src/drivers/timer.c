...
#define XGPT_CTL    *(volatile U32*)0x10200670
#define XGPT_IDX    *(volatile U32*)0x10200674
...
{
	XGPT_IDX = 0;
	XGPT_CTL = (bPowerOn ? 1 : 0) | 0x200;
	/* [10:8] : ckmode, 3'b100: 26MHz/4, 3'b010: 26MHz/2, 3'b001: 26MHz */
}
