...
import com.mediatek.smartmotion.enabler.FreeFallEnabler;
...
import com.mediatek.smartmotion.enabler.SnapshotEnabler;
...
public class MainActivity extends PreferenceActivity {
    ...
    private static final String[] ENTRY_FRAGMENTS = {
        ...
        PedometerFragment.class.getName(),
        PdrFragment.class.getName(),
        ConfigurableGesturetFragment.class.getName()
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            ...
            if (parcelables != null) {
                ...
                LogUtils.d(TAG, "size=" + mHeaders.size());
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (mHeaders != null) {
            ...
            LogUtils.d(TAG, "before save size:" + array.length);
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        if (sDemoMode) {
            int count = HeaderAdapter.POSITION_CONFIGURABLE_GESTURE
                    - HeaderAdapter.POSITION_IN_POCKET;
            for (int i = 0; i < count; i++) {
                target.remove(target.size() - 1);
            }
        }
        LogUtils.d(TAG, "onBuildHeaders");
        mHeaders= target;
    }
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private static final int POSITION_FREE_FALL = 7;
        private static final int POSITION_SNAPSHOT = 8;
        private static final int POSITION_PDR = 9;
        private static final int POSITION_CONFIGURABLE_GESTURE = 10;
        ...
        public HeaderAdapter(Context context, List<Header> objects) {
            ...
            FreeFallEnabler.unregisterAllSwitches();
            SnapshotEnabler.unregisterAllSwitches();
        }

        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            LogUtils.d(TAG, "getview, pos=" + position);
            ...
            switch (position) {
                ...
                case POSITION_SIGNIFICANT_MOTION:
                    ...
                    break;
                case POSITION_FREE_FALL:
                    FreeFallEnabler.registerSwitch(mContext, holder.switch_);
                    break;
                case POSITION_SNAPSHOT:
                    SnapshotEnabler.registerSwitch(mContext, holder.switch_);
                    break;
                case POSITION_PDR:
                    holder.switch_.setVisibility(View.GONE);
                    break;
                case POSITION_CONFIGURABLE_GESTURE:
                    holder.switch_.setVisibility(View.GONE);
                    break;
            }
