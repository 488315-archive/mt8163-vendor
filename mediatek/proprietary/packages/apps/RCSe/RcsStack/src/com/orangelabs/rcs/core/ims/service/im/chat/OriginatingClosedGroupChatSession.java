...
public class OriginatingClosedGroupChatSession extends GroupChatSession {
     ...
     */
    public OriginatingClosedGroupChatSession(ImsService parent, String conferenceId, String subject, ListOfParticipant participants) {
    ...
    private SipRequest createSipInvite() {
        logger.debug("createSipInvite()");
            ...
            if(isSecureProtocolMessage()){
                ...
                "a=chatroom:org.openmobilealliance.groupchat.closed" + SipUtils.CRLF +
