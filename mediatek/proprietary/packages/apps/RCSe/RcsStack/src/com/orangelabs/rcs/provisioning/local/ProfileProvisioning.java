...
public class ProfileProvisioning extends Activity {
    ...
    txt = (EditText)this.findViewById(R.id.ProfileAddress);
    txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.PROFILE_ADDRESS));
        
    txt = (EditText)this.findViewById(R.id.ProfileAddressPort);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.PROFILE_ADDRESS_PORT));
        
        txt = (EditText)this.findViewById(R.id.NABAddress);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.NAB_ADDRESS));
        
        txt = (EditText)this.findViewById(R.id.NABAddressPort);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.NAB_ADDRESS_PORT));
        
        txt = (EditText)this.findViewById(R.id.PublicAccountAddress);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS));
        
        txt = (EditText)this.findViewById(R.id.PublicAccountAddressPort);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS_PORT));
        
        txt = (EditText)this.findViewById(R.id.SSOAddress);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.SSO_ADDRESS));
        
        txt = (EditText)this.findViewById(R.id.SSOAddressPort);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.SSO_ADDRESS_PORT));
    ...
    private void save() {
        ...
        txt = (EditText)this.findViewById(R.id.ProfileAddress);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.PROFILE_ADDRESS, txt.getText().toString());
    
        txt = (EditText)this.findViewById(R.id.ProfileAddressPort);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.PROFILE_ADDRESS_PORT, txt.getText().toString());
        
        txt = (EditText)this.findViewById(R.id.NABAddress);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.NAB_ADDRESS, txt.getText().toString());
        
        txt = (EditText)this.findViewById(R.id.NABAddressPort);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.NAB_ADDRESS_PORT, txt.getText().toString());
        
        txt = (EditText)this.findViewById(R.id.PublicAccountAddress);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS, txt.getText().toString());
        
        txt = (EditText)this.findViewById(R.id.PublicAccountAddress);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS_PORT, txt.getText().toString());
        
        txt = (EditText)this.findViewById(R.id.SSOAddress);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.SSO_ADDRESS, txt.getText().toString());
        
        txt = (EditText)this.findViewById(R.id.SSOAddressPort);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.SSO_ADDRESS_PORT, txt.getText().toString());
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
            ...
            .setPositiveButton(R.string.label_ok, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    int profileAddressPort= 5060;
                    String nabAddress = "";
                    int nabAddressPort =5060;
                    String publicAccountAddress = "";
                    int publicAccountAddressPort = 5060;
                    String ssoAddress = "";
                    int ssoAddressPort = 5060;
                    ...
                    switch(index) {
                        ...
                        case 12: // JibeOrange
                            ...
                            break;
                        case 13: // OP01(Live)
                            homeDomain = "gd.ims.mnc000.mcc460.3gppnetwork.org";
                            sipUri = "IMSI" + "@" + "ims.mnc000.mcc460.3gppnetwork.org";
                            privateSipUri = sipUri;
                            imsPwd = "123456";
                            imsRealm = "";
                            imsAddrForMobile = "120.197.90.65";
                            imsPortForMobile = 5260;
                            imsAddrForWifi = "120.197.90.65";
                            imsPortForWifi = 5260;
                            confUri = "sip:1252000199@as99.gc.rcs1.chinamobile.com";
                            multiUri = "sip:msgas@as99.message.rcs1.chinamobile.com";
                            profileAddress = "http://122.70.137.46:8080/services";
                            //profileAddressPort= null;
                            nabAddress = "http://tsdm.gdapp.139friends.com";
                            nabAddressPort =9080;
                            publicAccountAddress = "http://122.70.137.46:8088/interface/index.php";
                            //publicAccountAddressPort = null;
                            ssoAddress = "";
                            //ssoAddressPort = 5060;
                            break;
                        case 14: // IOT Vendor
                            homeDomain = "setcom.eu";
                            sipUri = number + "@" + homeDomain;
                            privateSipUri = sipUri;
                            imsPwd = "123456";
                            imsRealm = "";
                            imsAddrForMobile = "10.23.205.43";
                            imsPortForMobile = 5060;
                            imsAddrForWifi = "10.23.205.43";
                            imsPortForWifi = 5060;
                            xdms = "http://setcom.eu:8080/services/";
                            xdmsLogin = sipUri;
                            xdmsPwd = "12345678";
                            confUri = "sip:Conference-Factory@setcom.eu";
                            multiUri = "sip:Conference-Factory@setcom.eu";
                            enduserConfirmUri = "sip:server@setcom.eu";
                            profileAddress = "http://122.70.137.46:8080/services";
                            //profileAddressPort= null;
                            nabAddress = "http://tsdm.gdapp.139friends.com";
                            nabAddressPort =9080;
                    ...
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.ProfileAddress);
                    txt.setText(profileAddress);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.ProfileAddressPort);
                    txt.setText(""+profileAddressPort);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.NABAddress);
                    txt.setText(nabAddress);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.NABAddressPort);
                    txt.setText(""+nabAddressPort);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.PublicAccountAddress);
                    txt.setText(publicAccountAddress);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.PublicAccountAddressPort);
                    txt.setText(""+publicAccountAddressPort);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.SSOAddress);
                    txt.setText(ssoAddress);
                    txt = (EditText)ProfileProvisioning.this.findViewById(R.id.SSOAddressPort);
                    txt.setText(""+ssoAddressPort);
                }
