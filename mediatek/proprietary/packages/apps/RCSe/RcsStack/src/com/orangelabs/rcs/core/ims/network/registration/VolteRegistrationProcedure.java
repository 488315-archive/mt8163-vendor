...
public class VolteRegistrationProcedure extends RegistrationProcedure {
    ...
    public void init() {
        ...
        String uri = "sip:" + imsi + "@" + getHomeDomain();
        RcsSettings.getInstance().setPublicUri(uri);
    }
...
public  void readSecurityClientHeader(SipResponse response) throws CoreException{
        
    }
    public  void writeSecurityClientHeader(SipRequest request) throws CoreException{
