...
public class PresenceService extends ImsService implements AddressBookEventListener , PresenceExtensionListener{
    ...
    public synchronized void start() {
        ...
        boolean isXDMOperationRequired = StartService.getXDMBootFlag(AndroidFactory.getApplicationContext());
        ...
        // It may be necessary to initiate the address book first launch or account check procedure
            ...
            StartService.setXDMBootFlag(AndroidFactory.getApplicationContext(), false);
		} catch (Exception e) {
			 if (logger.isActivated()) {
        ...
        if (logger.isActivated()) {
            logger.debug("before buildPartialPresenceInfoDocument");
        }
...
private String buildCapabilitiesTMO(String timestamp, Capabilities capabilities) {
        
        String t1_FileTransfer = "FileTransfer8"; 
        String SessModeMessa = "SessModeMessa";
        String DiscoveryPres = "DiscoveryPres";
        String FileTransferH = "FileTransferH";
        String VOLTE85062702 = "VOLTE85062702";
        ...
        publishXML +="<tuple id=\""+SessModeMessa +"\">" + SipUtils.CRLF +
            "  <status>"+ SipUtils.CRLF +"<basic>" + "open" + "</basic>"+ SipUtils.CRLF +"</status>" + SipUtils.CRLF +
            "  <op:service-description>" + SipUtils.CRLF +
            "    <op:service-id>" + "org.openmobilealliance:ChatSession" + "</op:service-id>" + SipUtils.CRLF +
        ...
        {
        publishXML +="<tuple id=\""+t1_FileTransfer+"\">" + SipUtils.CRLF +
            "  <status>"+ SipUtils.CRLF +"<basic>" + "open" + "</basic>"+ SipUtils.CRLF +"</status>" + SipUtils.CRLF +
            "  <op:service-description>" + SipUtils.CRLF +
            "    <op:service-id>" + PresenceUtils.FEATURE_RCS2_FT + "</op:service-id>" + SipUtils.CRLF +
            "    <op:version>1.0</op:version>" + SipUtils.CRLF +
        ...
        publishXML +="<tuple id=\""+DiscoveryPres+"\">" + SipUtils.CRLF +
            "  <status>"+ SipUtils.CRLF +"<basic>" + "open" + "</basic>"+ SipUtils.CRLF +"</status>" + SipUtils.CRLF +
            "  <op:service-description>" + SipUtils.CRLF +
            "    <op:service-id>" + "org.3gpp.urn:urn-7:3gpp-application.ims.iari.rcse.dp" + "</op:service-id>" + SipUtils.CRLF +
            "    <op:version>1.0</op:version>" + SipUtils.CRLF +
            "    <op:description>DiscoveryPresence</op:description>" + SipUtils.CRLF +
            "  </op:service-description>" + SipUtils.CRLF +
            "  <contact>" + ImsModule.IMS_USER_PROFILE.getPublicUri() + "</contact>" + SipUtils.CRLF +
            //"  <timestamp>" + timestamp + "</timestamp>" + SipUtils.CRLF +
            "</tuple>" + SipUtils.CRLF;
        ...
        "  <status>"+ SipUtils.CRLF +"<basic>" + "open" + "</basic>"+ SipUtils.CRLF +"</status>" + SipUtils.CRLF +
        "  <op:service-description>" + SipUtils.CRLF +
        "    <op:service-id>" + "org.openmobilealliance:File-Transfer-HTTP" + "</op:service-id>" + SipUtils.CRLF +
        "    <op:version>1.0</op:version>" + SipUtils.CRLF +
        ...
        if(capabilities.isIR94_VoiceCallSupported())
       {
        ...
        publishXML +="<tuple id=\""+VOLTE85062702+"\">" + SipUtils.CRLF +
        "  <status>"+ SipUtils.CRLF +"<basic>" + "open" + "</basic>"+ SipUtils.CRLF +"</status>" + SipUtils.CRLF +
        "<caps:servcaps>" + SipUtils.CRLF +
                "<caps:audio>true</caps:audio>" + SipUtils.CRLF;
             
                 //if video call supported
               if(((ViLTEExtension)vilteService).isActive())
                {
                    publishXML += "<caps:video>true</caps:video>" + SipUtils.CRLF ;
                }
                
               if(((ViLTEExtension)vilteService).isDuplex()){
               publishXML += "<caps:duplex>" + SipUtils.CRLF +
        ...
        "  <op:service-description>" + SipUtils.CRLF +
        "    <op:service-id>" + "org.3gpp.urn:urn-7:3gpp-service.ims.icsi.mmtel" + "</op:service-id>" + SipUtils.CRLF +
        "    <op:version>1.0</op:version>" + SipUtils.CRLF +
...
private String buildCapabilitiesTMO_2(String timestamp, Capabilities capabilities) {
    ...
    //PRESENCE DEISCOVERY
    publishXML+="<tuple id=\"t4\">" + SipUtils.CRLF +
    ...
    //File Transfer
    publishXML+= "<tuple id=\"t1\">" + SipUtils.CRLF +
        "  <status><basic>" + buildBooleanStatus(capabilities.isFileTransferSupported()) + "</basic></status>" + SipUtils.CRLF +
        "  <op:service-description>" + SipUtils.CRLF +
        "    <op:service-id>" + PresenceUtils.FEATURE_RCS2_FT + "</op:service-id>" + SipUtils.CRLF +
        "    <op:version>1.0</op:version>" + SipUtils.CRLF +
    ...
    publishXML +="<tuple id=\"t4\">" + SipUtils.CRLF +
        ...
        if(capabilities.isIR94_DuplexModeSupported() && ((ViLTEExtension)vilteService).isDuplex()){
            publishXML +=" <caps:duplex>"+"<caps:supported>" + SipUtils.CRLF +
                    "<caps:full/>" + SipUtils.CRLF +
                    "</caps:supported>" + SipUtils.CRLF +"</caps:video>" + SipUtils.CRLF;
        }
    ...
    */    
    ...
    private String buildPresenceInfoDocument(PresenceInfo info) {
        ...
        // Build capabilities
            document += buildCapabilitiesTMO_2(timestamp, RcsSettings.getInstance().getMyCapabilities());
        }else{
        // Build capabilities
