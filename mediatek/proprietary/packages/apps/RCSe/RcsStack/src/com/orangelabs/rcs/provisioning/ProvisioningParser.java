...
public class ProvisioningParser {
    ...
    private void parseServices(Node node) {
        ...
        String profileAuth = null;
        String nABAuth = null;
        String publicAccountAuth = null;
        String sSOAuth = null;
        ...
        if (childnode != null) {
            ...
            do {
                ...
                if (profileAuth == null) {
                    if ((profileAuth = getValueByParamName("ProfileAuth", childnode, TYPE_INT)) != null) {
                        if (profileAuth.equals("1")) {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.PROFILE_AUTH, RcsSettingsData.TRUE);
                        } else {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.PROFILE_AUTH, RcsSettingsData.FALSE);
                        }
                        continue;
                    }
                }
                ...
                if (nABAuth == null) {
                    if ((nABAuth = getValueByParamName("NABAuth", childnode, TYPE_INT)) != null) {
                        if (nABAuth.equals("1")) {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.NAB_AUTH, RcsSettingsData.TRUE);
                        } else {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.NAB_AUTH, RcsSettingsData.FALSE);
                        }
                        continue;
                    }
                }
                
                if (publicAccountAuth == null) {
                    if ((publicAccountAuth = getValueByParamName("PublicAccountAuth", childnode, TYPE_INT)) != null) {
                        if (publicAccountAuth.equals("1")) {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.PUBLIC_ACCOUNT_AUTH, RcsSettingsData.TRUE);
                        } else {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.PUBLIC_ACCOUNT_AUTH, RcsSettingsData.FALSE);
                        }
                        continue;
                    }
                }
                ...
                if (sSOAuth == null) {
                    if ((sSOAuth = getValueByParamName("SSOAuth", childnode, TYPE_INT)) != null) {
                        if (sSOAuth.equals("1")) {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.SSO_AUTH, RcsSettingsData.TRUE);
                        } else {
                            RcsSettings.getInstance().writeParameter(
                                    RcsSettingsData.SSO_AUTH, RcsSettingsData.FALSE);
                        }
                        continue;
                    }
                }
                ...
                if (standaloneMsgAuth == null) {
                    if ((sSOAuth = getValueByParamName("standaloneMsgAuth", childnode, TYPE_INT)) != null) {
                        if (sSOAuth.equals("1")) {
                            RcsSettings.getInstance().writeParameter(
    ...
    private void parseProfile(Node node) {
        ...
        if (childnode != null) {
            do {
                if (addr == null) {
                    if ((addr = getValueByParamName("Addr", childnode, TYPE_TXT)) != null) {
                        String[] address1 = addr.split(":");
                      //  address.add(nbAddress,address1[0]);
                        RcsSettings.getInstance().writeParameter(RcsSettingsData.PROFILE_ADDRESS,address1[0]);   
                        if (address1.length > 1) {
                         //   port.add(nbAddress,address1[1]);
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.PROFILE_ADDRESS_PORT,address1[1]);    
                        }
                        continue;
                    }
                }
                ...
                if (addrType == null) {
                    if ((addrType = getValueByParamName("AddrType", childnode, TYPE_TXT)) != null) {
                        
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.PROFILE_ADDRESS_TYPE,addrType);    
                        continue;
                    }
                }
     ...
     * @param node Node
     */
    private void parseNAB(Node node) {
        String addr = null;
        String addrType = null;
        if (node == null) {
            return;
            ...
            do {
                if (addr == null) {
                    if ((addr = getValueByParamName("Addr", childnode, TYPE_TXT)) != null) {
                        String[] address1 = addr.split(":");
                      //  address.add(nbAddress,address1[0]);
                        RcsSettings.getInstance().writeParameter(RcsSettingsData.NAB_ADDRESS,address1[0]);   
                        if (address1.length > 1) {
                         //   port.add(nbAddress,address1[1]);
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.NAB_ADDRESS_PORT,address1[1]);    
                        }
                        continue;
                    }
                }
                ...
                if (addrType == null) {
                    if ((addrType = getValueByParamName("AddrType", childnode, TYPE_TXT)) != null) {
                            ...
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.NAB_ADDRESS_TYPE,addrType);    
                        continue;
                    }
                }
            ...
            do {
                if (addr == null) {
                    if ((addr = getValueByParamName("Addr", childnode, TYPE_TXT)) != null) {
                        String[] address1 = addr.split(":");
                      //  address.add(nbAddress,address1[0]);
                        RcsSettings.getInstance().writeParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS,address1[0]);   
                        if (address1.length > 1) {
                         //   port.add(nbAddress,address1[1]);
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS_PORT,address1[1]);    
                        }
                        continue;
                    }
                }
                ...
                if (addrType == null) {
                    if ((addrType = getValueByParamName("AddrType", childnode, TYPE_TXT)) != null) {
                            ...
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.PUBLIC_ACCOUNT_ADDRESS_TYPE,addrType);    
                        continue;
                    }
                }
            ...
            do {
                if (addr == null) {
                    if ((addr = getValueByParamName("Addr", childnode, TYPE_TXT)) != null) {
                        String[] address1 = addr.split(":");
                      //  address.add(nbAddress,address1[0]);
                        RcsSettings.getInstance().writeParameter(RcsSettingsData.SSO_ADDRESS,address1[0]);   
                        if (address1.length > 1) {
                         //   port.add(nbAddress,address1[1]);
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.SSO_ADDRESS_PORT,address1[1]);    
                        }
                        continue;
                    }
                }
                ...
                if (addrType == null) {
                    if ((addrType = getValueByParamName("AddrType", childnode, TYPE_TXT)) != null) {
                            ...
                            RcsSettings.getInstance().writeParameter(RcsSettingsData.SSO_ADDRESS_TYPE,addrType);    
                        continue;
                    }
                }
                ...
                if (childnode.getNodeName().equals("characteristic")) {
                    if (childnode.getAttributes().getLength() > 0) {
                        ...
                        if (typenode != null) {
                            ...
                            if (typenode.getNodeValue().equalsIgnoreCase("PROFILE")) {
                                parseProfile(childnode);
                            } else
                            if (typenode.getNodeValue().equalsIgnoreCase("NAB")) {
                                parseNAB(childnode);
                            } else
                            if (typenode.getNodeValue().equalsIgnoreCase("PUBLICACCOUNT")) {
                                parsePublicAccount(childnode);
                            } else
                            if (typenode.getNodeValue().equalsIgnoreCase("SSO")) {
                                parseSSO(childnode);
                            }
                        }
                    }
