...
public class OriginatingExtendedFileSharingSession extends ImsFileSharingSession implements MsrpEventListener {
    ...
    private PauseResumeFileObject pauseInfo;
    ...
    public void handle403Forbidden(SipResponse resp) {
        ...
        if (warn == null || !warn.getText().contains("File is received")) {
            ...
            for (int i=0; i < getListeners().size(); i++) {
                ...
                listener.handleFileTransfered(getContent().getUrl());
            }
        }
   }
    ...
    private SipRequest createSipInvite() {
        ...
        if (pauseInfo != null) {
            ...
            hashselector = getRawHashSelector();
        }
        ...
        if (getThumbnail() != null) {
            encodedImage = Base64.encodeBase64ToString(getThumbnail());
        ...
        if (multipart) {
            ...
            if (rlistPart) {
                String resourceList = ChatUtils.generateMultiChatResourceList(
