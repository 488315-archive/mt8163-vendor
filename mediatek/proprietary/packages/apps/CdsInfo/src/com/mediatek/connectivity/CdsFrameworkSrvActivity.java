    ...
    private void updateFrameworkSrvInfo() {
        ...
        try {
            ...
            if (networkQuotaInfo != null) {
                ...
                infoString = "Actual:" + networkQuotaInfo.getEstimatedBytes()
                        + " Warning:" + networkQuotaInfo.getSoftLimitBytes()
                        + " Limit:" + networkQuotaInfo.getHardLimitBytes();
            ...
            if (networkPolicy != null) {
                ...
                for (i = 0; i < networkPolicy.length; i++) {
                    infoString = infoString + "[" + i + "]"
                                + networkPolicy[i].toString().replace(',', '\n')
                                + "\r\n----------------------\r\n";
                }
