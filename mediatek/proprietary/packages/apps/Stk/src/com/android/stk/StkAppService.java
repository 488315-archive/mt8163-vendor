...
public class StkAppService extends Service implements Runnable {
    ...
    private String getTelephonyPlmnFrom(Intent intent) {
        if (intent.getBooleanExtra(TelephonyIntents.EXTRA_SHOW_PLMN, false)) {
            ...
            CatLog.d(LOG_TAG, "getTelephonyPlmnFrom plmn:" + plmn);
            if (plmn != null) {
                return plmn;
            }
        }
...
*/
    ...
    private Call.State isPhoneIdle(int slotId) {
        /* TODO: Gemini and non-Gemini are different begine */
        if (slotId == PhoneConstants.SIM_ID_3 &&
            TelephonyManager.getDefault().getPhoneCount() < 3) {
            CatLog.d(LOG_TAG, "isPhoneIdle(), Does not support SIM3");
            return Call.State.IDLE;
        }
        if (slotId == PhoneConstants.SIM_ID_4 &&
            TelephonyManager.getDefault().getPhoneCount() < 4) {
...
*/
    ...
    private void launchMenuActivity(Menu menu, int slotId) {
        ...
        if (menu == null) {
            ...
            if (mStkContext[slotId].mOpCode == OP_CMD
                ...
                CatLog.d(LOG_TAG, "no need launchMenuActivity");
                return;
            }
    ...
    public boolean isActivityActivated(Context context,String activityString) {
        ...
        CatLog.d(LOG_TAG, "isActivityActivated: " + topActivity);
    ...
    private final BroadcastReceiver mSpnReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.SPN_STRINGS_UPDATED_ACTION.equals(action)) {
                ...
                CatLog.d(LOG_TAG, "mSpnReceiver SPN_STRINGS_UPDATED_ACTION simId:" + simId);
