...
public class TeledongleDemoActivity extends PreferenceActivity implements
	...
	public void setPreferenceState(boolean flag){
	    Log.d(LOG_TAG, "setPreferenceState() flag=" + flag);
		radioEnable = flag;
	...
	public void InitUi() {
        ...
        //if(radioEnable){
            //setRadio(radioEnable);
        //}
		//Log.d(LOG_TAG, "INITUI radioEnable1:" + radioEnable + " dongleinsert:" + isDonglePluged()
		//		+ " simready:" + isSimReady());
		//mSwitchPreference.setChecked(isDonglePluged() && radioEnable && isSimReady() && (!isAirplaneModeOn(this)));
	...
	public void onResume() {
		...
		radioEnable = mSwitchPreference.isChecked();
		boolean flag = isDonglePluged() && radioEnable && isSimReady() && (!isAirplaneModeOn(this)) && (!hasWifiConnectivity());
		Log.d(LOG_TAG, "onResume() radioEnable=" + radioEnable + ", isDonglePluged=" + isDonglePluged()
				+ ", isSimReady=" + isSimReady() + ", hasWifiConnectivity=" + hasWifiConnectivity() + ", flag=" + flag);
		setPreferenceState(flag);
		if(hasWifiConnectivity()){
			mSwitchPreference.setEnabled(false);
		}
        mServiceState = mTedongleManager.getServiceState().getState();
