...
/**
 * Show CrossMount test modules.
 *
 * @author mtk04258
 *
 */
public class CmList extends ListActivity {

    private static final String TAG = "EM/CmList";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mModuleList.add(getString(R.string.cm_sensor_test));
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (mModuleList.get(position).equals(
                getString(R.string.cm_sensor_test))) {
                startActivity(new Intent(CmList.this, CmSensorTest.class));
        }
    }
}
