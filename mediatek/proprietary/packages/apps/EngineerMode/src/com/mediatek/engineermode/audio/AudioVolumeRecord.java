...
public class AudioVolumeRecord extends Activity implements OnClickListener {
    ...
    public static final String TAG = "EM/AudioVolumeRecord";
    ...
    private void initComponents() {
        ...
        mAppAdatper = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, mArraySpinnerApp);
    ...
    private void updateValue() {
        //Update Ul Gain
        String strValue = AudioTuningJni.getParams(CATEGORY_RECORDVOL, TYPE_APP
                + "," + mCurrentApp + "," + TYPE_PROFILE + "," + mCurrentProfile, UL_GAIN);
    ...
    private void setUlGain() {
        ...
        if (!AudioTuningJni.setParams(CATEGORY_RECORDVOL,
                TYPE_APP + "," + mCurrentApp + "," + TYPE_PROFILE + "," + mCurrentProfile,
                UL_GAIN, strValue)
