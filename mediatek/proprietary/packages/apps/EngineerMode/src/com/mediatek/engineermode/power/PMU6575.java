...
public class PMU6575 extends TabActivity implements OnClickListener {
	...
	private String[][] mFilesFor8163 = {
            {"MT6323_BUCK_VPROC_STATUS", mPromptSw},
            {"MT6323_BUCK_VSYS_STATUS", mPromptSw},
            {"MT6323_BUCK_VPA_STATUS", mPromptSw},
            {"SYM827_BUCK_VPROC_STATUS", mPromptSw},
            {"SEP", ""},
            {"MT6323_LDO_VTCXO_STATUS", mPromptSw},
            {"MT6323_LDO_VA_STATUS", mPromptSw},
            {"MT6323_LDO_VCAMA_STATUS", mPromptSw},
            {"MT6323_LDO_VCN28_STATUS", mPromptSw},
            {"MT6323_LDO_VCN33_STATUS", mPromptSw},
            {"MT6323_LDO_VIO28_STATUS", mPromptSw},
            {"MT6323_LDO_VUSB_STATUS", mPromptSw},
            {"MT6323_LDO_VMC_STATUS", mPromptSw},
            {"MT6323_LDO_VMCH_STATUS", mPromptSw},
            {"MT6323_LDO_VEMC_3V3_STATUS", mPromptSw},
            {"MT6323_LDO_VGP1_STATUS", mPromptSw},
            {"MT6323_LDO_VGP2_STATUS", mPromptSw},
            {"MT6323_LDO_VGP3_STATUS", mPromptSw},
            {"MT6323_LDO_VCN_1V8_STATUS", mPromptSw},
            {"MT6323_LDO_VSIM1_STATUS", mPromptSw},
            {"MT6323_LDO_VSIM2_STATUS", mPromptSw},
            {"MT6323_LDO_VRTC_STATUS", mPromptSw},
            {"MT6323_LDO_VCAM_AF_STATUS", mPromptSw},
            {"MT6323_LDO_VIBR_STATUS", mPromptSw},
            {"MT6323_LDO_VM_STATUS", mPromptSw},
            {"MT6323_LDO_VRF18_STATUS", mPromptSw},
            {"MT6323_LDO_VIO18_STATUS", mPromptSw},
            {"MT6323_LDO_VCAMD_STATUS", mPromptSw},
            {"MT6323_LDO_VCAM_IO_STATUS", mPromptSw},
            {"SEP", ""},
            {"MT6323_BUCK_VPROC_VOLTAGE", mPromptUnit},
            {"MT6323_BUCK_VSYS_VOLTAGE", mPromptUnit},
            {"MT6323_BUCK_VPA_VOLTAGE", mPromptUnit},
            {"SYM827_BUCK_VPROC_MICROVOLTS", mPromptUnit},
            {"SEP", ""},
            {"MT6323_LDO_VMC_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VMCH_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VEMC_3V3_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VGP1_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VGP2_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VGP3_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VSIM1_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VSIM2_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VCAM_AF_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VIBR_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VM_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VCAMD_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VCAMA_VOLTAGE", mPromptUnit},
            {"MT6323_LDO_VCN33_VOLTAGE", mPromptUnit}
    };

	private String[][] mFilesFor8163_remap = {
            {"regulator.1/status", mPromptSw},
            {"regulator.2/status", mPromptSw},
            {"regulator.3/status", mPromptSw},
            {"regulator.29/status", mPromptUnit},
            {"SEP", ""},
            {"regulator.4/status", mPromptSw},
            {"regulator.8/status", mPromptSw},
            {"regulator.9/status", mPromptSw},
            {"regulator.5/status", mPromptSw},
            {"regulator.6/status", mPromptSw},
            {"regulator.10/status", mPromptSw},
            {"regulator.11/status", mPromptSw},
            {"regulator.12/status", mPromptSw},
            {"regulator.13/status", mPromptSw},
            {"regulator.14/status", mPromptSw},
            {"regulator.15/status", mPromptSw},
            {"regulator.16/status", mPromptSw},
            {"regulator.17/status", mPromptSw},
            {"regulator.18/status", mPromptSw},
            {"regulator.19/status", mPromptSw},
            {"regulator.20/status", mPromptSw},
            {"regulator.21/status", mPromptSw},
            {"regulator.22/status", mPromptSw},
            {"regulator.23/status", mPromptSw},
            {"regulator.25/status", mPromptSw},
            {"regulator.24/status", mPromptSw},
            {"regulator.26/status", mPromptSw},
            {"regulator.27/status", mPromptSw},
            {"regulator.28/status", mPromptSw},
            {"SEP", ""},
            {"regulator.1/microvolts", mPromptUnit},
            {"regulator.2/microvolts", mPromptUnit},
            {"regulator.3/microvolts", mPromptUnit},
            {"regulator.29/microvolts", mPromptUnit},
            {"SEP", ""},
            {"regulator.12/microvolts", mPromptUnit},
            {"regulator.13/microvolts", mPromptUnit},
            {"regulator.14/microvolts", mPromptUnit},
            {"regulator.15/microvolts", mPromptUnit},
            {"regulator.16/microvolts", mPromptUnit},
            {"regulator.17/microvolts", mPromptUnit},
            {"regulator.19/microvolts", mPromptUnit},
            {"regulator.20/microvolts", mPromptUnit},
            {"regulator.22/microvolts", mPromptUnit},
            {"regulator.23/microvolts", mPromptUnit},
            {"regulator.25/microvolts", mPromptUnit},
            {"regulator.27/microvolts", mPromptUnit},
            {"regulator.9/microvolts", mPromptUnit},
            {"regulator.6/microvolts", mPromptUnit}
};

    private String[][] mFilesFor8127 = {
            {"BUCK_VPROC_STATUS", mPromptSw},
            {"BUCK_VSYS_STATUS", mPromptSw},
            {"BUCK_VPA_STATUS", mPromptSw},
            {"SEP", ""},
    ...
    private String[][] mFilesFor8127_remap = {
            {"regulator.1/status", mPromptSw},
            {"regulator.2/status", mPromptSw},
            {"regulator.3/status", mPromptSw},
            {"SEP", ""},
    ...
    public void onClick(View arg0) {
        ...
        if (ChipSupport.MTK_6589_SUPPORT <= ChipSupport.getChip()) {
            ...
            regFile = "/sys/devices/soc/1000d000.pwrap/1000d000.pwrap:mt6323/mt6323-pmic/pmic_access";
        } else {
            if (mBankIndex == 0) {
                //regFile = "/sys/devices/platform/mt-pmic/pmic_access_bank0";
                regFile = "/sys/devices/soc/1000d000.pwrap/1000d000.pwrap:mt6323/mt6323-pmic/pmic_access_bank0";
            } else if (mBankIndex == 1) {
                // regFile = "/sys/devices/platform/mt-pmic/pmic_access_bank1";
                regFile = "/sys/devices/soc/1000d000.pwrap/1000d000.pwrap:mt6323/mt6323-pmic/pmic_access_bank1";
            } else {
        ...
        public void run() {
            while (mRun) {
                ...
                if (ChipSupport.MTK_6589_SUPPORT <= ChipSupport.getChip()) {
                    ...
                    if (ChipSupport.isCurrentChipEquals(ChipSupport.MTK_8127_SUPPORT)) {
                        fileArray = mFilesFor8127;
                        fileArrayRemap = mFilesFor8127_remap;
                    }
                    if (ChipSupport.isCurrentChipEquals(ChipSupport.MTK_8163_SUPPORT)) {
                        fileArray = mFilesFor8163;
                        fileArrayRemap = mFilesFor8163_remap;
                    }
                ...
                for (int i = 0; i < fileArray.length; i++) {
                    ...
                    // cmd = "cat /sys/devices/platform/mt-pmic/" + fileArrayRemap[i][0];
                    if(null != fileArrayRemap){
                        cmd = "cat /sys/class/regulator/" + fileArrayRemap[i][0];                        
                    }else{
