...
public class AudioVolumeVoIP extends Activity implements OnClickListener {
    ...
    public static final String TAG = "EM/AudioVolumeVoIP";
    ...
    private void updateValue() {
        //Update Ul Gain
        String strValue = AudioTuningJni.getParams(CATEGORY_VOIPVOL,
        ...
        String strDlGain = AudioTuningJni.getParams(CATEGORY_VOIPVOL,
                TYPE_PROFILE + "," + mCurrentProfile, DL_GAIN);
    ...
    private void setDlGain() {
        ...
        if (!AudioTuningJni.setParams(CATEGORY_VOIPVOL, TYPE_PROFILE + "," + mCurrentProfile,
