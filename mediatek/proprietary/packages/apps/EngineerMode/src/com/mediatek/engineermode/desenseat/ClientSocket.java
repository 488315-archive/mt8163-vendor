                    ...
                    while ((mDataInput != null) && ((count = mDataInput.read(mDataBuffer)) != -1)) {
                        ...
                        if (result.contains(PMTK_ACK_HEAD)) {
                            ...
                            if (startIndex != -1) {
                                ...
                                Elog.v(TAG, "trim response 1 =  " + result);
                            }

                            Elog.v(TAG, "trim response startIndex =  " + startIndex);
                            int endIndex = result.indexOf("*");
                            if (endIndex != -1) {
                                Elog.v(TAG, "trim response endIndex =  " + endIndex);
                                mResponse = result.substring(0, endIndex);
                                Elog.v(TAG, "trim response after =  " + mResponse);
                            }
...
/*                        if (startIndex != -1) {
                        ...
                        if (startIndex != -1) {
                            ...
                            Elog.v(TAG, "trim response 1 =  " + strTemp);
                        } else {
                            break;
                        }
    ...
    private String trim(String response) {
        ...
        Elog.v(TAG, "trim response before =  " + response);

        int startIndex = response.indexOf("$PMTK828");
        if (startIndex != -1) {
            response = response.substring(startIndex + 5);
            Elog.v(TAG, "trim response 1 =  " + response);
        }
        ...
        if (endIndex != -1) {
            ...
            Elog.v(TAG, "trim response after =  " + response);
            return response;
        }
