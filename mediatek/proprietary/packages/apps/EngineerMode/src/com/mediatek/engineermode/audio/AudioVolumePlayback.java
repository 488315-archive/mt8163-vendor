...
public class AudioVolumePlayback extends Activity implements OnClickListener {
    ...
    public static final String TAG = "EM/AudioVolumePlayback";
    ...
    private void initComponents() {
        ...
        mVolumeTypeAdatper = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, mArraySpinnerVolumeType);
        ...
        mProfileAdatper = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, mArraySpinnerProfile);
    ...
    private void initTableValue() {
        ...
        String strMaxValue = AudioTuningJni.getParams(CATEGORY_VOLUME,
                PARAM_COMMON, PARAM_DG_VALUE_MAX);
        String strMaxIndex = AudioTuningJni.getParams(CATEGORY_VOLUME,
                PARAM_COMMON, PARAM_DG_INDEX_MAX);
        String strMinIndex = AudioTuningJni.getParams(CATEGORY_VOLUME,
                PARAM_COMMON, PARAM_DG_INDEX_MIN);
        String strValueStep = AudioTuningJni.getParams(CATEGORY_VOLUME,
                PARAM_COMMON, PARAM_DG_STEP);
        ...
        Elog.d(TAG, "Init UL gain table: mUlMaxValue " + mDgMaxValue + " mUlMinValue " + mDgMinValue
                + " mUlMaxIndex " + mDgMaxIndex + " mUlValueStep " + mDgValueStep);

        //Init Headset table value

        strMaxValue = AudioTuningJni.getParams(CATEGORY_VOLUME, PARAM_COMMON, PARAM_HS_VALUE_MAX);
        strValueStep = AudioTuningJni.getParams(CATEGORY_VOLUME, PARAM_COMMON, PARAM_HS_STEP);
        String strIndexList = AudioTuningJni.getChecklist(CATEGORY_PLAYBACK_ANA,
                HEADSET_PGA, PARAM_HS_LIST);
        ...
        mHsMinValue = mHsMaxValue - mHsValueStep * java.lang.Math.abs(stfMinIndex - mHsMaxIndex);
        Elog.d(TAG, "Init Headset table: mHsMaxValue " + mHsMaxValue + " mHsMinValue " +
                mHsMinValue + " mHsMaxIndex " + mHsMaxIndex +
        " mHsValueStep " + mHsValueStep + " mHsIndexStep " + mHsIndexStep);

        //Init Speaker gain table value

        strMaxValue = AudioTuningJni.getParams(CATEGORY_VOLUME, PARAM_COMMON, PARAM_SPK_VALUE_MAX);
        strValueStep = AudioTuningJni.getParams(CATEGORY_VOLUME, PARAM_COMMON, PARAM_SPK_STEP);
        strIndexList = AudioTuningJni.getChecklist(CATEGORY_PLAYBACK_ANA,
                SPEAKER_PGA, PARAM_SPK_LIST);
        ...
        mSpkMinValue = mSpkMaxValue - mSpkValueStep * java.lang.Math.abs(mSpkMaxIndex
                - spkMinIndex);
        Elog.d(TAG, "Init Speaker table: mSpkMaxValue " + mSpkMaxValue + " mSpkMinValue " +
        mSpkMinValue + " mStfMaxIndex " + mSpkMaxIndex +
        " mSpkValueStep " + mSpkValueStep + " mSpkIndexStep " + mSpkIndexStep);
    }
    ...
    private void updateValue() {
        ...
        if ((TYPE_VOLUME_TYPE_RING.equals(mCurrentVolumeType))
            ...
            valueHeadset = AudioTuningJni.getParams(CATEGORY_PLAYBACK_ANA, TYPE_VOLUME_TYPE
                    + "," + TYPE_VOLUME_TYPE_RING_ALARM + "," +
                    TYPE_PROFILE + "," + mCurrentProfile, HEADSET_PGA);
            valueSpeaker = AudioTuningJni.getParams(CATEGORY_PLAYBACK_ANA, TYPE_VOLUME_TYPE
                    + "," + TYPE_VOLUME_TYPE_RING_ALARM + "," +
                    TYPE_PROFILE + "," + mCurrentProfile, SPEAKER_PGA);

        } else {
            valueHeadset = AudioTuningJni.getParams(CATEGORY_PLAYBACK_ANA, TYPE_VOLUME_TYPE
                    + "," + TYPE_VOLUME_TYPE_OTHERS + "," +
                    TYPE_PROFILE + "," + mCurrentProfile, HEADSET_PGA);
            valueSpeaker = AudioTuningJni.getParams(CATEGORY_PLAYBACK_ANA, TYPE_VOLUME_TYPE
                    + "," + TYPE_VOLUME_TYPE_OTHERS + "," +
                    TYPE_PROFILE + "," + mCurrentProfile, SPEAKER_PGA);
        ...
        String strDigiGain = AudioTuningJni.getParams(CATEGORY_PLAYBACK_DIGI,
                TYPE_VOLUME_TYPE + "," + mCurrentVolumeType + "," + TYPE_PROFILE +
                "," + mCurrentProfile, DIGI_GAIN);
        mArrayDlText.clear();
    ...
    private void setDigiGain() {
        ...
        if (!AudioTuningJni.setParams(CATEGORY_PLAYBACK_DIGI,
                TYPE_VOLUME_TYPE + "," + mCurrentVolumeType + "," + TYPE_PROFILE +
                "," + mCurrentProfile, DIGI_GAIN, strValueDigiGain)
    ...
    private void setSpeakerPga() {
        ...
        value = (mSpkMaxValue - value) / mSpkValueStep; //Get index to minus
        value = value / mSpkIndexStep * mSpkIndexStep; //Make to be multiple value of index step
        ...
        if ((TYPE_VOLUME_TYPE_RING.equals(mCurrentVolumeType))
                || (TYPE_VOLUME_TYPE_ALARM.equals(mCurrentVolumeType))) {
            setResult = AudioTuningJni.setParams(CATEGORY_PLAYBACK_ANA, TYPE_VOLUME_TYPE
                    + "," + TYPE_VOLUME_TYPE_RING_ALARM +
    ...
    private void setHeadsetPga() {
        ...
        value = value / mHsIndexStep * mHsIndexStep; //Make to be multiple value of index step
    ...
    public Dialog onCreateDialog(int dialogId) {
        ...
        case DIALOG_RESULT:
            if ((mStrErrorInfo != null) && (!mStrErrorInfo.isEmpty())) {
                ...
                .setTitle(R.string.set_error_title).setMessage(
                        mStrErrorInfo).setPositiveButton(
                ...
                .setTitle(R.string.set_success_title).setMessage(
                        R.string.audio_volume_set_success).setPositiveButton(
                    android.R.string.ok, new DialogInterface.OnClickListener() {
        ...
        case DIALOG_INIT_FAIL:
            return new AlertDialog.Builder(AudioVolumePlayback.this)
            .setTitle(R.string.init_error_title).setMessage(
                    R.string.init_error_msg).setPositiveButton(
                android.R.string.ok, new DialogInterface.OnClickListener() {
