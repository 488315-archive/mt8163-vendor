...
public class Power extends Activity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ChipSupport.getChip() > ChipSupport.MTK_6580_SUPPORT) {
            items.add("Power and Performance Customization");
            items.add("Wakelock debug log");
        }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        case 2:
            ...
            break;
        case 3:
            intent.setClass(this, PowerPerformance.class);
            break;
        case 4:
            intent.setClass(this, WakelockDebugLog.class);
            break;
        default:
            break;
        }
    ...
    private boolean isSupportLPDebug() {
		// alps-mp-m0.mp8 tb8163 and tb8127 not support Low power debug
		return false;
/*
