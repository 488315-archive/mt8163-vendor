...
import com.mediatek.engineermode.desenseat.DesenseAtActivity.FunctionTask;
...
public class ApiTestActivity extends Activity {
    ...
    protected static final String TAG = "EM/APITest";
    ...
    private class ApiTestAdapter extends ArrayAdapter<TestItem> {
         ...
         *              the context
         */
        public ApiTestAdapter(Context activity) {
            super(activity, 0);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (r == null) {
                ...
                holder.result.setText((r == true) ? PASS : FAIL);
            }
