...
public class PrefsFragment extends PreferenceFragment {
    ...
    private void removeUnsupportedItems() {
        ...
        if (isWifiOnly()) {
            ...
            removePreference(screen, "md_notification");
        ...
        if (ChipSupport.MTK_6797_SUPPORT <= ChipSupport.getChip()) {
        ...
        if (!("OP09".equals(mOptr) &&
             ("SEGDEFAULT".equals(mOpSeg) || "SEGC".equals(mOpSeg)))) {
        ...
        if (!FeatureSupport.isSupported(FeatureSupport.FK_CROSSMOUNT_SUPPORT)) {
            removePreference(screen, "cm_settings");
        }
        ...
        if (ChipSupport.getChip() == ChipSupport.MTK_8127_SUPPORT ) {
            removePreference(screen, "de_sense");
        }
...
//            removePreference(screen, "lcm");
        ...
        removePreference(screen, "modem_switch");
        if (!FeatureSupport.isSupported(FeatureSupport.FK_WORLD_PHONE)) {
            removePreference(screen, "world_mode");
        }
