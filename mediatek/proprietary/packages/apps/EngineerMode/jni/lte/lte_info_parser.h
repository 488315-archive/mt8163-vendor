...
typedef struct
{
    ...
    l4c_em_emm_timersrv_para_struct         emm_timerif_para;
...
typedef struct _em_el1_cell_info_struct {
    kal_uint8 band;
    kal_uint8 ant_port;
    kal_uint8 dl_bw;
    kal_uint8 ul_bw;
...
typedef struct _em_el1_dl_status_struct {
    kal_int16 dl_rssi[2];
    kal_int16 dl_rsrp[2];
    kal_int16 dl_rsrq[2];
    kal_int16 dl_sinr[2];
...
typedef struct _em_el1_ul_status_struct {
