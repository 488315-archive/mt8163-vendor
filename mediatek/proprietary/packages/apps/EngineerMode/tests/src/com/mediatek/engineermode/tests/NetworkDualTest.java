...
public class NetworkDualTest extends ActivityUnitTestCase<NetworkInfoSimType> {
    ...
    protected void setUp() throws Exception {
        ...
        mIntent.setComponent(new ComponentName(mContext, NetworkInfoSimType.class.getName()));
    }
    ...
    public void test01_Precondition() {
        ...
        ListView listView = (ListView) activity.findViewById(R.id.ListView_dualtalk_networkinfo);
