...
public class MemoryTest extends SingleLaunchActivityTestCase<Memory> {
    ...
    public void test03_Flashidenty() {
        ...
        assertEquals(sActivity.getString(R.string.memory_title_flash), actual);
    ...
    public void test04_FlashActivity() {
        ...
        boolean actual = activity instanceof Flash;
    ...
    public void test05_FsInfo() {
        ...
        sSolo.goBack();
        sSolo.sleep(SLEEP_TIME);
        Log.d("@M_" + TAG, "[FOR_NATA_MEMORY_FS_INFO_PASS]");
    }

    @UiAnnotation
    public void test06_PartInfo() {
        sSolo.clickOnText(sListView.getAdapter().getItem(0).toString());
        Activity activity = sSolo.getCurrentActivity();
        sSolo.clickOnText(activity.getString(R.string.memory_partition_info));
        sSolo.goBack();
        sSolo.sleep(SLEEP_TIME);
        Log.d("@M_" + TAG, "[FOR_NATA_MEMORY_PATITION_INFO_PASS]");
    }

    @UiAnnotation
    public void test07_Help() {
