...
public class NetworkInformationTest extends ActivityUnitTestCase<NetworkInfoInfomation> {
    ...
    protected void setUp() throws Exception {
        ...
        mIntent.setComponent(new ComponentName(mContext, NetworkInfoInfomation.class.getName()));
    ...
    public void test03_PageDown() {
        ...
        mIntent.putExtra("mChecked", mChecked);
        NetworkInfoInfomation activity = startActivity(mIntent, null, null);
        final Button mPageDown = (Button) activity.findViewById(R.id.NetworkInfo_PageDown);
