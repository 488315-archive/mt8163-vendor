...
*/
    ...
    public void testCase03_TestNormalMode() {
        ...
        Elog.d("Audio/Test", "Normal Mode" );
        String targetTag = "Normal Mode";
        if (!searchScrollList(targetTag)) {
            return;
        }
        mSolo.clickOnText(targetTag);
        mSolo.waitForActivity(AudioModeSetting.class.getName());
        mSolo.sleep(EmOperate.TIME_MID);
        mSolo.assertCurrentActivity("current activity should be AudioModeSetting", AudioModeSetting.class);
...
//      mSolo.clickOnText(mAudioFuncList.getAdapter().getItem(0).toString());
    ...
    public void testCase04_TestHeadSetMode() {
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        Elog.d("Audio/Test", "Headset Mode" );
        String targetTag = "Headset Mode";
        if (!searchScrollList(targetTag)) {
            return;
        }
        mSolo.clickOnText(targetTag);
...
//        mSolo.sleep(EmOperate.TIME_MID);
    ...
    public void testCase05_TestLoudSpekMode() {
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        Elog.d("Audio/Test", "LoudSpeaker Mode" );
        String targetTag = "LoudSpeaker Mode";
        if (!searchScrollList(targetTag)) {
            return;
        }
        mSolo.clickOnText(targetTag);
...
//        mSolo.sleep(EmOperate.TIME_MID);
    ...
    public void testCase06_TestHeadsetLoudSpekMode() {
        ...
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        Elog.d("Audio/Test", "Headset_LoudSpeaker Mode" );
        String targetTag = "Headset_LoudSpeaker Mode";
        if (!searchScrollList(targetTag)) {
            return;
        }
        mSolo.clickOnText(targetTag);
...
//        mSolo.sleep(EmOperate.TIME_MID);
    ...
    public void testCase07_TestSpeechEnhanc() {
        ...
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        Elog.d("Audio/Test", "Speech Enhancement" );
        String targetTag = "Speech Enhancement";
        if (!searchScrollList(targetTag)) {
            return;
        }
        ...
        mSolo.clickOnText(targetTag);
        mSolo.waitForActivity(AudioSpeechEnhancementV1.class.getName());
        mSolo.sleep(EmOperate.TIME_MID);
        mSolo.assertCurrentActivity("current activity should be AudioSpeechEnhancementV1", AudioSpeechEnhancementV1.class);
...
//        mSolo.sleep(EmOperate.TIME_MID);
    ...
    public void testCase08_TestDebugInfo() {
        ...
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        Elog.d("Audio/Test", "Debug Info" );
        String targetTag = "Debug Info";
        if (!searchScrollList(targetTag)) {
            return;
        }
        if (sAudioTuningVer != AudioTuningVer.VER_1) {
        ...
        mSolo.clickOnText(targetTag);
        mSolo.waitForActivity(AudioDebugInfo.class.getName());
        mSolo.sleep(EmOperate.TIME_MID);
        mSolo.assertCurrentActivity("current activity should be AudioDebugInfo", AudioDebugInfo.class);
//        mSolo.clickOnText(mAudioFuncList.getAdapter().getItem(item).toString());
//        mSolo.sleep(EmOperate.TIME_MID);
        mSolo.goBack();
    ...
    public void testCase09_TestSpeechLog() {
        ...
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        String targetTag = "Speech Logger";
        if (!searchScrollList(targetTag)) {
            return;
        }
        if (sAudioTuningVer != AudioTuningVer.VER_1) {
        ...
        mSolo.clickOnText(targetTag);
        mSolo.waitForActivity(AudioSpeechLoggerXV1.class.getName());
        mSolo.sleep(EmOperate.TIME_MID);
        mSolo.assertCurrentActivity("current activity should be AudioSpeechLoggerXV1", AudioSpeechLoggerXV1.class);
//        mSolo.clickOnText(mAudioFuncList.getAdapter().getItem(item).toString());
//        mSolo.sleep(EmOperate.TIME_MID);
    ...
    public void testCase10_TestAudioLog() {
        ...
        verifyPreconditions();
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
        Elog.d("Audio/Test", "Audio Logger" );
        String targetTag = "Audio Logger";
        if (!searchScrollList(targetTag)) {
            return;
        }
        mSolo.clickOnText(targetTag);
        mSolo.waitForActivity(AudioAudioLogger.class.getName());
        mSolo.sleep(EmOperate.TIME_MID);
        mSolo.assertCurrentActivity("current activity should be AudioAudioLogger", AudioAudioLogger.class);
//        mSolo.clickOnText(mAudioFuncList.getAdapter().getItem(item).toString());
//        mSolo.sleep(EmOperate.TIME_MID);
        ArrayList<CheckBox> checkBoxs = mSolo.getCurrentViews(CheckBox.class);
        assertNotNull(checkBoxs);
    ...
    public void testCase11_TestDebugSession() {
        Elog.d("Audio/Test", "Debug Session" );
        mSolo.assertCurrentActivity("current activity should be Audio", Audio.class);
    ...
    private void verifyPreconditions() {
        ...
        Elog.d("Audio/Test", "verifyPreconditions" );
