...
public class Const {
    ...
    public static final String ACTION_CDMA_AUTO_SMS_REGISTER_FEASIBLE = "android.provider.Telephony.SMS_STATE_CHANGED";
    ...
    public static final String ACTION_CDMA_UTK_MENU_SELECTION =
