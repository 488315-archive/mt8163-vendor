...
final class CheckItemKeySet {
    ...
    public static final String CI_MODE_SPE_VALUE = "worldphonevalue";
    public static final String CI_MODE_SPE_VALUE_FTA = "worldphonevalueandModemTestFTA";
    public static final String CI_MODE_SPE_VALUE_RS = "worldphonevalueandModemTestRS";
    public static final String CI_MODE_SPE_VALUE_ANITE = "worldphonevalueandModemTestAnite";
...
class CTLTERFRRMCheckProvider extends CheckItemProviderBase {
    CTLTERFRRMCheckProvider(Context c) {
        ...
        if("OP09".equals(SystemProperties.get("ro.operator.optr")) &&
           ...
           "SEGC".equals(SystemProperties.get("ro.operator.seg"))) {
            mArrayItems.add(
              new CheckWorldPhoneAndModemTest(c, CheckItemKeySet.CI_MODE_SPE_VALUE_FTA));
            mArrayItems.add(new CheckIRsetting(c, CheckItemKeySet.CI_IR_LWG));
        }
        mArrayItems.add(new CheckDataConnect(c, CheckItemKeySet.CI_DATA_CONNECT_OFF));
    }
...
class CTLTEPCTRAndSCheckProvider extends CheckItemProviderBase {
    CTLTEPCTRAndSCheckProvider(Context c) {
        ...
        if("OP09".equals(SystemProperties.get("ro.operator.optr")) &&
           ...
           "SEGC".equals(SystemProperties.get("ro.operator.seg"))) {
            mArrayItems.add(
              new CheckWorldPhoneAndModemTest(c, CheckItemKeySet.CI_MODE_SPE_VALUE_RS));
        }
...
class CTLTEPCTANITECheckProvider extends CheckItemProviderBase {
    CTLTEPCTANITECheckProvider(Context c) {
        ...
        if("OP09".equals(SystemProperties.get("ro.operator.optr")) &&
           ...
           "SEGC".equals(SystemProperties.get("ro.operator.seg"))) {
            mArrayItems.add(
              new CheckWorldPhoneAndModemTest(c, CheckItemKeySet.CI_MODE_SPE_VALUE_ANITE));
        }
        mArrayItems.add(new CheckIRsetting(c, CheckItemKeySet.CI_IR_FTA_LTE));
        mArrayItems.add(new CheckDataConnect(c, CheckItemKeySet.CI_DATA_CONNECT_OFF));
    }
