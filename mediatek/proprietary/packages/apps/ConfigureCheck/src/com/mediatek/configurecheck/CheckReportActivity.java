...
import com.mediatek.configurecheck.CheckResultActivity.ListViewItem;
...
public class CheckReportActivity extends Activity implements View.OnClickListener {
    ...
    private void exportCheckReport() {
        ...
        mExportFileName =
          String.format(getString(R.string.export_file_name), getFileNameTime(), getFileNameIMEI());
    ...
    private boolean createExportDir() {
        ...
        mExportDirStr =
          String.format(mExportDirStr, Environment.getExternalStorageDirectory().getAbsolutePath());
