...
public class FileInfoAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        /// Modified by Bright.L @{
        String path = currentItem.getFileAbsolutePath();
        if (MountPointManager.getInstance().isExternalMountPath(path)) {
            // OTG mount point name use R.string.storage_usb
            viewHolder.mName.setText(Resources.getSystem().getString(com.android.internal.R.string.storage_usb));
        } else {
