...
public class Thumbnail {
    ...
    */
     ...
     * @param oldThumbnail the old thumbnail before get last.
    ...
    */
    public static int getLastThumbnailFromContentResolver(String storageFilePath,
            ContentResolver resolver, Thumbnail[] result, Thumbnail oldThumbnail) {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                if (oldThumbnail != null) {
                    LogHelper.d(TAG, "id:" + id
                            + ",oldId:" + oldThumbnail.mThumbnailId + ",orientation:"
                ...
                if (oldThumbnail == null || id != oldThumbnail.mThumbnailId
                    ...
                    LogHelper.d(TAG, "same file, don't need decode again!");
