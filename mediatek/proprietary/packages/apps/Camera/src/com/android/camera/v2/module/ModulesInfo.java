...
public class ModulesInfo {
    ...
    public static void setupModules(Context context, ModuleManager moduleManager) {
        ...
        registerMultiCameraMoudle(moduleManager, ModuleControllerAdapter.MULTI_CAMERA_MODULE_INDEX);
    }
    ...
    private static void registerMultiCameraMoudle(ModuleManager moduleManager, final int moduleId) {
        moduleManager.registerModule(new ModuleManager.ModuleAgent() {
