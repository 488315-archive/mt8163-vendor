...
public class FixedAspectSurfaceView extends SurfaceView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mAspectRatio > 0) {
            ...
            if (Math.abs((mAspectRatio - fullScreenRatio)) <= ASPECT_TOLERANCE) {
                ...
                LogHelper.i(TAG, "full screen case");
        ...
        LogHelper.i(TAG, "originalPreviewIsLandscape = " + originalPreviewIsLandscape
        ...
        LogHelper.i(TAG, "After onMeasure  aspectRatio = " + mAspectRatio +
    ...
    public boolean setAspectRatio(double aspectRatio) {
        LogHelper.i(TAG, "setAspectRatio aspectRatio = " + aspectRatio);
     ...
     */
    public void expand() {
        LogHelper.i(TAG, "expand mPreviewWidth = " + mPreviewWidth +
    ...
    private void setLayoutSize(int width, int height) {
        LogHelper.i(TAG, "setLayoutSize mPreviewWidth = " + mPreviewWidth
                + " width = " + width
                + " mPreviewHeight = " + mPreviewHeight
                + " height = " + height);
