...
public class FileSaverImpl implements IFileSaver {
     ...
     */
    public boolean saveRawFile(byte[] photoData, String fileName, long date,
        ...
        mListener = listener;
        if (mRawSaveRequest.getDataSize() > 0) {
            Log.i(TAG, "[saveRawFile]Current SaveRequest is used, copy new one!");
            mRawSaveRequest = mFileSaver.copyRawRequest(mRawSaveRequest);
        }
