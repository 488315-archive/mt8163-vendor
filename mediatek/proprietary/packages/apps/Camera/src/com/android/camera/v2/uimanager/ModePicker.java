...
public class ModePicker extends AbstractUiManager implements View.OnClickListener,
    ...
    private static final int MODE_NUM_ALL              = 6;
    ...
    // Add for Cross Mount
    private static final int MODE_CROSS_MOUNT           = 4;
    private static final int MODE_PHOTO                = 5;
    ...
    private static final int[] MODE_ICON_ORDER = {MODE_PHOTO, MODE_STEREO_CAMERA, MODE_PHOTO_PIP,
            MODE_FACE_BEAUTY, MODE_PANORAMA, MODE_CROSS_MOUNT};
    ...
    static {
        ...
        KEY_OF_MODES[MODE_CROSS_MOUNT]      = SettingKeys.KEY_MULTI_CAMERA_SINK;
    }
    ...
    static {
        ...
        MODE_ICONS_HIGHTLIGHT[MODE_CROSS_MOUNT]      = R.drawable.ic_mode_crossmount_focus;
    };
    ...
    static {
        ...
        MODE_ICONS_NORMAL[MODE_CROSS_MOUNT]          = R.drawable.ic_mode_crossmount_normal;
    };
    ...
    protected View getView() {
        ...
        mModeViews[MODE_CROSS_MOUNT]    = (RotateImageView) view.findViewById(R.id.mode_cros_mount);
