...
public class ModeChangeAdapter {
    ...
    static {
        ...
        sModeMapping.put(SettingKeys.KEY_MULTI_CAMERA_SINK,
                ModeChangeListener.MODE_MULTI_CAMERA_SINK);
    }
    ...
    public static boolean isNeedSwitchModule(String oldeMode, String newMode) {
        if (SettingKeys.KEY_PHOTO_PIP.equals(oldeMode)
                || SettingKeys.KEY_MULTI_CAMERA_SINK.equals(oldeMode)
                || SettingKeys.KEY_PHOTO_PIP.equals(newMode)
                || SettingKeys.KEY_MULTI_CAMERA_SINK.equals(newMode)) {
            return true;
        }
        return false;
    }
    ...
    public static int getModuleIndex(String currentMode) {
        ...
        if (SettingKeys.KEY_MULTI_CAMERA_SINK.equals(currentMode)) {
            index = ModuleControllerAdapter.MULTI_CAMERA_MODULE_INDEX;
        }
        return index;
    }
}
