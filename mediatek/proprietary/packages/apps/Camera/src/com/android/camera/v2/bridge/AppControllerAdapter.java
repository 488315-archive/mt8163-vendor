...
public class AppControllerAdapter implements AppController {
    ...
    private IMultiCameraDeviceAdapter                       mMultiCameraDeviceAdapter;
    ...
    @Override
    public IMultiCameraDeviceAdapter getMultiCameraDeviceAdapter() {
        if (mMultiCameraDeviceAdapter == null) {
            mMultiCameraDeviceAdapter = new MultiCameraDeviceAdapterImpl(getActivity());
        }
        return mMultiCameraDeviceAdapter;
    }
