...
public class ResourceRenderer extends Renderer {
    ...
    public void init() {
        LogHelper.i(TAG, "initResource");
        initProgram();
    }

    public void updateTemplate(int resourceId) {
        LogHelper.i(TAG, "updateTemplate resourceId = " + resourceId);
    ...
    private void initVertexData(float rCenterX, float rCenterY, float edge) {
        LogHelper.i(TAG, "initVertexData rCenterX = " + rCenterX + " rCenterY = " +
                rCenterY + " edge = " + edge);
    ...
    public void draw(float rCenterX, float rCenterY, float edge, FloatBuffer vtxBuf) {
        LogHelper.i(TAG, "ResourceRendrer draw start rCenterX = "
        ...
        LogHelper.i(TAG, "ResourceRendrer draw end");
    }
