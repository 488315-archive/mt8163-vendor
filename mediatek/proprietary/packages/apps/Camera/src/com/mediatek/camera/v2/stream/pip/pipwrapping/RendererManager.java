...
public class RendererManager {
    ...
    public void switchPIP() {
        LogHelper.i(TAG, "switchPIP , mPipSwitched:" + mPipSwitched);
    ...
    public void setPreviewSize(Size previewSize) {
        ...
        if (mRendererTexWidth == previewSize.getWidth() && mRendererTexHeight
            ...
            LogHelper.i(TAG, "[setPreviewTextureSize]- the same size set, ignore!");
            return;
        }
        if (mEglHandler != null) {
    ...
    public SurfaceTexture getMainCamPvSt() {
        LogHelper.i(TAG, "getMainCamPvSt");
    ...
    public SurfaceTexture getMainCamCapSt() {
        LogHelper.i(TAG, "getMainCamCapSt");
    ...
    public SurfaceTexture getSubCamCapSt() {
        LogHelper.i(TAG, "getSubCamCapSt");
    ...
    private SurfaceTexture _getMainPvSurfaceTexture() {
        synchronized (mRenderLock) {
            if (mEglHandler == null) {
                LogHelper.e(TAG, "call _getSubPvSurfaceTexture after init/un-init");
                return null;
            }
            ...
            LogHelper.i(TAG, "_getMainPvSurfaceTexture mPreviewBottomSurfaceTexture = "
    ...
    private SurfaceTexture _getSubPvSurfaceTexture() {
        synchronized (mRenderLock) {
            ...
            LogHelper.i(TAG, "_getSubPvSurfaceTexture mPreviewTopSurfaceTexture = "
    ...
    private class EglHandler extends Handler {
        ...
        private void createRenderers() {
            LogHelper.i(TAG, "[createRenderers]+ mSurfaceTextureHandler = "
            ...
            LogHelper.i(TAG, "[createRenderers]-");
        }
