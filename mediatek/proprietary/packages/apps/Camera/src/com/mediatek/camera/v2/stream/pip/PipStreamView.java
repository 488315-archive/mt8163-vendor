...
public class PipStreamView implements IPipView {
    ...
    public boolean onBackPressed() {
        LogHelper.i(TAG, "onBackPressed mTemplateSelectViewShown:" + mTemplateSelectViewShown);
    ...
    public void onPreviewVisibleChanged(boolean visible) {
        LogHelper.i(TAG, "onPreviewVisibleChanged visible:" + visible);
        if (visible) {
            showPipView();
        } else {
            hidePipView();
    ...
    public boolean onTouchEvent() {
        LogHelper.i(TAG, "onTouchEvent mTemplateSelectViewShown:" + mTemplateSelectViewShown);
        if (mTemplateSelectViewShown) {
            hideTemplateSelectView();
            return true;
        }
    ...
    private void showPipView() {
        LogHelper.i(TAG, "showPipView mPipSettingShown:" + mPipSettingShown);
        if (mPipSettingShown) {
            return;
        }
    ...
    private void hidePipView() {
        LogHelper.i(TAG, "hidePipView mIndicator:" + mIndicator);
    ...
    private void showTemplateSelectView() {
        LogHelper.i(TAG, "[showTemplateSelectView]+");
    ...
    private void hideTemplateSelectView() {
        LogHelper.i(TAG, "[hideTemplateSelectView]+ mIsShowingPipSetting = "
        ...
        LogHelper.i(TAG, "[hideTemplateSelectView]-");
    }
    ...
    private void initialModeViewsAndLayout() {
        ...
        LogHelper.i(TAG, "initialModeViewsAndLayout mOrientation = " + mDisplayRotation);
    }
    ...
    private int getItemLayoutMargin() {
        ...
        LogHelper.i(TAG, "getItemLayoutMargin itemLayoutMargin = " + itemLayoutMargin
    ...
    private void highlightCurrentMode() {
        LogHelper.i(TAG, "highlightCurrentMode()");
        for (int i = 0; i < PIP_TEMPLATE_NUM; i++) {
            if (mModeViews[i] != null) {
    ...
    private void removeAllLayout() {
        LogHelper.i(TAG, "removeAllLayout()");
    ...
    private class ViewClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            LogHelper.i(TAG, "onClick v.getId() = " + v.getId());
            switch (v.getId()) {
