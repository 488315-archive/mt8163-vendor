...
public class SegmentMaskOperator {
    ...
    public SegmentMaskInfo getSegmentMaskInfoFromFile(String filePath) {
        ...
        if (mEnableDump) {
            mXmpInterface.writeStringToFile(mDumpPath + "SegmentMaskInfo_Read.txt", segmentMaskInfo
                    .toString());
        }
    ...
    private boolean writeSegmentMaskInfoToJpg(String srcFilePath, String dstFilePath,
        ...
        if (mEnableDump) {
            mXmpInterface.writeStringToFile(mDumpPath + "SegmentMaskInfo_Written.txt", maskInfo
                    .toString());
        }
