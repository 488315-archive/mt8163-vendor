...
public class SdPresenterImpl implements ISdPresenterListener, IDetectionPresenter {
    private static final Tag TAG = new Tag(SdPresenterImpl.class.getSimpleName());
    ...
    public void startDetection() {
        if (mIsSdStarted) {
            LogHelper.i(TAG, "smile detection has been stared so return");
            return;
        }
    ...
    public void stopDetection() {
        if (!mIsSdStarted) {
            LogHelper.i(TAG, "smile detection has been stopped or not open so return");
            return;
        }
