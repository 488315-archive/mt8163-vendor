...
public class SettingKeys {
    ...
    public static final int ROW_SETTING_SINK_CAMERA               = 58; //common
    public static final int ROW_SETTING_MULTI_PREVIEW             = 59;
    ...
    static {
        ...
        SETTING_TYPE[ROW_SETTING_ISO]                       = APPLY_TO_NATIVE;
