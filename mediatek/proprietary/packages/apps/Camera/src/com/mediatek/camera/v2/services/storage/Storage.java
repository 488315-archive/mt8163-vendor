 ...
 class Storage {
     ...
     */
     static int getStorageHintInfo() {
         ...
         if (leftSpace == STORAGE_STATE_UNAVAILABLE) {
         ...
         } else if (leftSpace == STORAGE_STATE_PREPARING) {
             return R.string.preparing_sd;
         } else if (leftSpace == STORAGE_STATE_UNKNOWN_SIZE) {
             ...
             if (isMultiStorage()) {
                 // EMMC only
                 if (isSDCard()) {
                     return com.mediatek.internal.R.string.storage_sd;
                 } else if (isHaveExternalSDCard()) {
                     return com.mediatek.internal.R.string.storage_withsd;
                 } else {
                     return com.mediatek.internal.R.string.storage_withoutsd;
                 }
             } else {
                 return com.mediatek.internal.R.string.storage_withoutsd;
             }
    ...
    private static boolean isSDCard() {
        return StorageManagerEx.isExternalSDCard(sMountPoint);
    }

    private static boolean isMultiStorage() {
    ...
    private static boolean isHaveExternalSDCard() {
