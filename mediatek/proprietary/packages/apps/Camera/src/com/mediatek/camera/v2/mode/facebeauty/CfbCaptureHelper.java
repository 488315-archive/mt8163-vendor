...
public class CfbCaptureHelper {
    private static final Tag TAG = new Tag(CfbCaptureHelper.class.getSimpleName());
    ...
    public static short getLightSourceMode(int awbMode) {
        ...
        LogHelper.i(TAG, "[getLightSourceMode] awbMode = " + awbMode
    ...
    public static short getExposureProgram(int sceneMode) {
        ...
        LogHelper.i(TAG, "[getExposureProgram] sceneMode = " + sceneMode
    ...
    public static void saveJpegExifInfo(byte[] data, TotalCaptureResult result, int orientation) {
        LogHelper.i(TAG, "[saveJpegExifInfo] ++++++++");
        try {
            ...
            if (exif != null) {
                ...
                LogHelper.i(TAG, "[result from capture],focusNumber = " + focusNumber
                ...
                LogHelper.i(TAG, "[update exif state] setFNumberOk = " + setFNumberOk
            ...
            LogHelper.e(TAG, "[saveJpegExifInfo] error", e);
            e.printStackTrace();
        }
        LogHelper.i(TAG, "[saveJpegExifInfo] -----");
    ...
    public static void readJpegExifInfo(ExifInterface exif) {
        ...
        LogHelper.i(TAG, "[result from exif],imageWidth = " + imageWidth
