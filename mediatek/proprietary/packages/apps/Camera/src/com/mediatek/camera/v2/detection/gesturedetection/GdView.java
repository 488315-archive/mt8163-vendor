...
public class GdView implements CountDownView.OnCountDownStatusListener, IGdView {
    private static final Tag TAG = new Tag(GdView.class.getSimpleName());
    ...
    public void onRemainingSecondsChanged(int remainingSeconds) {
        LogHelper.d(TAG, "onRemainingSecondsChanged remainingSeconds is " + remainingSeconds);
    ...
    public void onCountDownFinished() {
        LogHelper.d(TAG, "onCountDownFinished");
    ...
    public void showGestureView() {
        LogHelper.d(TAG, "onGestureStarted");
