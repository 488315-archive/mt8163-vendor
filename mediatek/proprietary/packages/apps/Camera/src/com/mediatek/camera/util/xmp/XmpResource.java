...
public class XmpResource {
    ...
    // /////////////////////////XMP EXTENSION MAIN(1ST EXTENSION
    // PACKET)////////////
    ...
    public static final byte[] XMP_EXT_MAIN_BYTES =
            new byte[] { 0x00, 0x05, 0x05, 0x05, 0x0, 0x0, 0x0, 0x0 };

    public static final int XMP_EXT_REPLACE_2_BYTES_OFFSET = 0x45; // use this
                                                                   // to replace
                                                                   // 0x05,0x05
    ...
    // ////////////////XMP EXTENSION SLAVE(2nd, 3rd... EXTENSION
    // PACKET)////////////
    ...
    public static final byte[] XMP_EXT_SLAVE_BYTES = new byte[] { 0x00, 0x05, 0x05,
            0x05, 0x0 };
 ...
 // use 1 byte for
    ...
    //same with XMP but reserve 4 bytes 4 bytes for total lenght
    private static final int TEMP_NUM = 0xffb4;
    public static final int JPS_PACKET_SIZE = TEMP_NUM - 2 - TOTAL_LENGTH_TAG_BYTE;
    public static final int JPS_PURE_DATA_SIZE_PER_PACKET = JPS_PACKET_SIZE
            - TYPE_JPS_DATA.length()
