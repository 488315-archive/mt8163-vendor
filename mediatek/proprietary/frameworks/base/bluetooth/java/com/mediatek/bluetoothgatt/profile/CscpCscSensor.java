...
import com.mediatek.bluetoothgatt.service.Cscs;
import com.mediatek.bluetoothgatt.service.Dis;
//........................................................................ Customized End: Import //

/**
 * Public API for the GATT Cycling Speed and Cadence Profile(Server).
 *
 ...
 * Role: CscSensor
 */
public class CscpCscSensor extends ServerBase {
    private static final boolean DBG = true;
    private static final String TAG = "CscpCscSensor";

    /**
     * Create a CscpCscSensor object and init value.
     *
     * @param context App context
     */
    public CscpCscSensor(Context context) {
        super(context);

        if (DBG) {
            Log.d(TAG, "CscpCscSensor()");
        }
    }
    ...
    protected void loadServicesConfig() {
        addService(new Cscs());
        addService(new Dis());
        cfgService(GattUuid.SRVC_CSCS).setSupport(true);
     ...
     */
    public void notifyCscsCscMeasurement(
            CharacteristicBase characteristic) {
        if (DBG) {
            Log.d(TAG, "notifyCscsCscMeasurement()");
        }

        notify(GattUuid.SRVC_CSCS,
     ...
     * @param characteristic The local characteristic that has been updated
     */
    public void notifyCscsScControlPoint(
            CharacteristicBase characteristic) {
        if (DBG) {
            Log.d(TAG, "notifyCscsScControlPoint()");
        }
