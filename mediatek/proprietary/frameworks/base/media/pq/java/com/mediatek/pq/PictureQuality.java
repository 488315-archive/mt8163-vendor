...
public class PictureQuality {
    ...
    public static boolean setBlueLightStrength(int strength) {
        return nativeSetBlueLightStrength(strength);
    }
    ...
    private static native boolean nativeSetBlueLightStrength(int strength);
    private static native int nativeGetBlueLightStrength();
    private static native boolean nativeEnableBlueLight(boolean isEnable);
