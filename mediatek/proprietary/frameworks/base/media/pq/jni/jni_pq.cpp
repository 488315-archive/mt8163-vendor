...
static jboolean nativeSetBlueLightStrength(JNIEnv* env, jclass clz, jint strength)
{
    UNUSED(env);
    UNUSED(clz);
    ...
    if (client.setBlueLightStrength(strength) != NO_ERROR) {
...
static jint nativeGetBlueLightStrength(JNIEnv* env, jclass clz)
{
    ...
    if (client.getBlueLightStrength(&strength) != NO_ERROR) {
...
static jboolean nativeEnableBlueLight(JNIEnv* env, jclass clz, jboolean isEnable)
{
    UNUSED(env);
    UNUSED(clz);
    ...
    if (client.enableBlueLight(isEnable ? true : false) != NO_ERROR) {
    ...
    UNUSED(isEnable);
    ALOGE("[JNI_PQ] enableBlueLight() not supported.");
    return JNI_FALSE;
...
static jboolean nativeIsBlueLightEnabled(JNIEnv* env, jclass clz)
{
    ...
    if (client.getBlueLightEnabled(&isEnabled) != NO_ERROR) {
        ALOGE("[JNI_PQ] enableBlueLight() failed!");
        return JNI_FALSE;
    }
...
static JNINativeMethod g_methods[] = {
    ...
    {"nativeSetBlueLightStrength", "(I)Z", (void*)nativeSetBlueLightStrength},
    {"nativeGetBlueLightStrength", "()I", (void*)nativeGetBlueLightStrength},
    {"nativeEnableBlueLight", "(Z)Z", (void*)nativeEnableBlueLight},
