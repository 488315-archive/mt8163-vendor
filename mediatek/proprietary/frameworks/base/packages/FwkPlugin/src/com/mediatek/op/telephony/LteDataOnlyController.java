...
public class LteDataOnlyController implements ILteDataOnlyController {
    ...
    public boolean checkPermission(int subId) {
        ...
        if (getExternalModemSlot() == slotId) {
    ...
    private boolean is4GDataOnly() {
        ...
        if (subId != null) {
            ...
            return (patternLteDataOnly == RILConstants.NETWORK_MODE_LTE_TDD_ONLY);
        }
        return false;
    }
    ...
    private boolean isSupportTddDataOnlyCheck() {
        ...
        boolean isCdmaLteDcSupport = SystemProperties.get("ro.mtk_svlte_support").equals("1");
        boolean isExternalModemSlot = (getExternalModemSlot() >= 0);
