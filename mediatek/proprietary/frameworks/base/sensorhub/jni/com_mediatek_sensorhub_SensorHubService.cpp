...
static void nativeAddConGesture(JNIEnv *env, jobject thiz, jint gesture, jint cgesture)
{
    sp<SensorHubManager> mgr = getSensorHubManager(env, thiz);
    if (mgr == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    mgr->addConGesture(gesture, cgesture);
    //ALOGV("nativeAddConGesture: gesture=%d, cgesture=%d", gesture, cgesture);
}

static void nativeCancelConGesture(JNIEnv *env, jobject thiz, jint gesture, jint cgesture)
{
    sp<SensorHubManager> mgr = getSensorHubManager(env, thiz);
    if (mgr == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    mgr->cancelConGesture(gesture, cgesture);
    //ALOGV("nativeCancelConGesture: gesture=%d, cgesture=%d", gesture, cgesture);
}
...
static JNINativeMethod gMethods[] = {
    ...
    {"nativeAddConGesture",     "(II)V",                            (void*)nativeAddConGesture },
    {"nativeCancelConGesture",  "(II)V",                            (void*)nativeCancelConGesture },
};
