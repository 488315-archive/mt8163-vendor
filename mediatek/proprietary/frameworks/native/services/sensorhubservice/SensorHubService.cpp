...
void SensorHubService::addConGesture(int gesture, int cgesture)
{
    ALOGV("SensorHubService addConGesture gesture=%d, cgesture=%d", gesture, cgesture);
    Mutex::Autolock _l(mLock);
    SensorHubDevice& dev(SensorHubDevice::getInstance());
    dev.addConGesture(gesture, cgesture);
}

void SensorHubService::cancelConGesture(int gesture, int cgesture)
{
    ALOGV("SensorHubService cancelConGesture gesture=%d, cgesture=%d", gesture, cgesture);
    Mutex::Autolock _l(mLock);
    SensorHubDevice& dev(SensorHubDevice::getInstance());
    dev.cancelConGesture(gesture, cgesture);
}
