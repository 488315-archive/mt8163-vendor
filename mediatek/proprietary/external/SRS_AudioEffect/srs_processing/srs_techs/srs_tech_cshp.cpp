...
void SRS_Source_CSHP::Create(SRS_Source_Out *pOut){
    ...
    SRS_CSHP_CreateObj(&Obj, pObjBuffer, NULL, NULL); // Ignore Klocwork warning here. This is used as intended.
...
void SRS_Source_CSHP::Config(SRS_Source_Out *pOut, SRS_Tech_CSHP *pCFG, bool bBypass){
    ...
    if (DIFF_FORCED(TBFreq) || DIFF_FORCED(TBAnalyze)){
		...
		SRS_TruBassHDFilterDesignFloat(pCFG->TBFreq, pCFG->TBAnalyze, SampleRate, TBCoefs);
