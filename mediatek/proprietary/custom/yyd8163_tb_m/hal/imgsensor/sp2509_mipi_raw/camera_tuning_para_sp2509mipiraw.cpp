...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            3677500, -1270000, 150000, -797500, 3457500, -102500, -437500, -2010000, 5007500
        },
        {  // i4P10[9]
            1097875, -873827, -230603, -3430, -149620, 159362, 39219, 510261, -549480
        },
        {  // i4P01[9]
            450395, -408760, -48205, -164395, -281511, 448246, -158524, -145406, 303930
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AE NVRAM
    {
        ...
        {
        {
            ...
            // PWB light area
            {
                ...
                // Warm fluorescent
                {
                    -202,    // PWFluoRightBound
                    -402,    // PWFluoLeftBound
                    -159,    // PWFluoUpperBound
                    -359    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -202,    // PIncaRightBound
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, 
                    {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}, {512, 512, 550}
                }, // CWF
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}
