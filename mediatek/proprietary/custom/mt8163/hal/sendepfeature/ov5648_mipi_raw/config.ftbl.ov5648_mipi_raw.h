    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "2880x1728",   // This is the max picture size, ratio is 5:3, which is the same to the max preview size ratio
            )
        ), 
    )
#else
...
#warning "Use  Dynamic Feature Table Algorithm: Picture Sizes..."
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_PICTURE_SIZE_SCENE(
            ...
            ITEM_AS_MAX_("2880x1920"),		// Not use 2560x1920, because it can generate: 2880x1728  // 2880x1920
