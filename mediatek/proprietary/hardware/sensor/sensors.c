...
typedef enum SENSOR_NUM_DEF
{
	...
	#ifdef CUSTOM_KERNEL_FLIP_DETECTION_SENSOR
        FLIP_DECTION_NUM,
	#endif
...
#ifdef CUSTOM_KERNEL_UNCALI_MAG_SENSOR
    #ifndef UNCALI_MAG
        #define UNCALI_MAG             "MAGNETOMETER"
...
#ifdef CUSTOM_KERNEL_FLIP_DETECTION_SENSOR
	#ifndef FLIP_DETECTION
		#define FLIP_DETECTION 		"FLIP_DETECTION"
		#define FLIP_DETECTION_VENDER	"MTK"
	#endif
	#ifndef FLIP_DETECTION_RANGE
		#define FLIP_DETECTION_RANGE 	85.0f
	#endif
	#ifndef FLIP_DETECTION_RESOLUTION
		#define FLIP_DETECTION_RESOLUTION 	0.1f
	#endif
	#ifndef FLIP_DETECTION_POWER
		#define FLIP_DETECTION_POWER 	0.5f
	#endif
#endif
...
struct sensor_t sSensorList[] =
{
	...
	{
		.name		= FLIP_DETECTION,
		.vendor 	= FLIP_DETECTION_VENDER,
		.version	= 1,
		.handle 	= ID_FLIP_DETECTION+ID_OFFSET,
		.type		= SENSOR_TYPE_FLIP_DETECTION,
		.maxRange	= FLIP_DETECTION_RANGE,//600.0f,
		.resolution	= FLIP_DETECTION_RESOLUTION,//0.0016667f,
		.power		= FLIP_DETECTION_POWER,//0.25f,
		.minDelay   = -1,  //SENSOR_FLAG_ONE_SHOT_MODE
		.stringType    = SENSOR_STRING_TYPE_FLIP_DETECTION,
		.reserved	= {}
	},
#endif
