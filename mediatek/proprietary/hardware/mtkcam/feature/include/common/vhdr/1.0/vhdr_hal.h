...
public:
    ...
    */
    virtual MINT32 GetBufLCSO(android::sp<NSCam::IImageBuffer>& spBuf) = 0;
#if 0
        /**
       ...
       */
    virtual MVOID DoVHdr(LCEI_DMA_INFO *apLceiDmaInfo,const android::sp<IImageBuffer>& lcsoBuf) = 0;
#endif
    ...
    /**
         ...
         *@param[in] lcsoBuf : lcso output from HW. We just record its mem addr into DMA Info now.
       */
    virtual MVOID PushMetadata(NSCam::IMetadata &halMetaData,const NSCam::IImageBuffer* lcsoBuf) = 0;
