...
public:
    ...
    /**
         ...
         *-EIS_RETURN_NO_ERROR indicates success, otherwise indicates fail
       */
    virtual MINT32 DoEis(const EIS_PASS_ENUM &aEisPass, EIS_HAL_CONFIG_DATA *apEisConfig = NULL, MINT64 aTimeStamp = -1, MINT64 aExpTime = 0) = 0;
    ...
    /**
         ...
         *-EIS_RETURN_NO_ERROR indicates success, otherwise indicates fail
       */
    virtual MINT32 DoEis(const EIS_PASS_ENUM &aEisPass, NSCam::NSIoPipe::NSCamIOPipe::QBufInfo const &pBufInfo) = 0;
    ...
    /**
         ...
         *-EIS_RETURN_NO_ERROR indicates success, otherwise indicates fail
       */
    virtual MINT32 DoCalibration(const EIS_PASS_ENUM &aEisPass, EIS_HAL_CONFIG_DATA *apEisConfig = NULL, MINT64 aTimeStamp = -1, MINT64 aExpTime = 0) = 0;
    ...
    /**
         *@brief Get EIS algorithm result
    ...
    /**
       ...
       */
    virtual MVOID GetEisGmv(MINT32 &aGMV_X, MINT32 &aGMV_Y, MUINT32 *confX=NULL, MUINT32 *confY=NULL) = 0;
    ...
    virtual MINT32 GetBufEis(android::sp<NSCam::IImageBuffer>& spBuf) = 0;
    virtual MINT32 NotifyEis(NSCam::NSIoPipe::NSCamIOPipe::QBufInfo&  pBufInfo) = 0;
    virtual MINT32 NotifyEis(android::sp<NSCam::IImageBuffer>& spBuf) = 0;
