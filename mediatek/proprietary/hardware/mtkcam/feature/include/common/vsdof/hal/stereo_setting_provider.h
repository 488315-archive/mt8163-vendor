...
//Adjust module rotate here~
#define MODULE_ROTATE 0 //Should be one of values in ENUM_ROTATION
enum ENUM_ROTATION
{
...
public:
    ...
    static ENUM_ROTATION getModuleRotation() { return static_cast<ENUM_ROTATION>(MODULE_ROTATE); }
    /**
