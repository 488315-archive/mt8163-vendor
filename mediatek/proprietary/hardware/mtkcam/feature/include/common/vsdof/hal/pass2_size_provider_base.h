...
public:
    ...
    virtual MSize getWROTSize( ENUM_STEREO_SCENARIO eScenario __attribute__((unused))) const { return MSIZE_ZERO; }
    virtual MSize getIMG2OSize( ENUM_STEREO_SCENARIO eScenario __attribute__((unused))) const { return MSIZE_ZERO; }
    virtual MSize getIMG3OSize( ENUM_STEREO_SCENARIO eScenario __attribute__((unused))) const { return MSIZE_ZERO; }
