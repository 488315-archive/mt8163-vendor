...
public:
    ...
    virtual MINT32 DoEis(const EIS_PASS_ENUM &aEisPass, EIS_HAL_CONFIG_DATA *apEisConfig = NULL, MINT64 aTimeStamp = -1, MINT64 aExpTime = 0);

    virtual MINT32 DoCalibration(const EIS_PASS_ENUM &aEisPass,EIS_HAL_CONFIG_DATA *apEisConfig = NULL, MINT64 aTimeStamp = -1, MINT64 aExpTime = 0);
    ...
    virtual MINT32 NotifyEis(android::sp<NSCam::IImageBuffer>& spBuf);
