...
MBOOL HDR::writeHDROutputFrame_cam3()
{
    ...
    // write hdr result to jpeg and thumbnail buffer
    {
        ...
        // TODO: enable this part if the aspect ratio of
        // NOTE: due to the dimension of hdr output frame has been swapped,
        // we need to restore it to calculate the crop region
        //{
        //    MRect dstRect =
        //        (transform & eTransform_ROT_90) ?
        //        MRect(mHDROutputFrames[0]->getImgSize().h,
        //                mHDROutputFrames[0]->getImgSize().w) :
        //        MRect(mHDROutputFrames[0]->getImgSize().w,
        //                mHDROutputFrames[0]->getImgSize().h);
        //
        //    // the crop region and hdr result are not the same
        //    MRect cropRegion =
        //        calCrop(cropRegion, MRect(hdrResult->getImgSize().w, hdrResult->getImgSize().h));
        //
