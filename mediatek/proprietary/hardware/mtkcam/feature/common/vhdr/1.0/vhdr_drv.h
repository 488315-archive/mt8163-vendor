...
#define VHDR_RUN_LEGACY 0
// HW ready means we can set RMG,LSC by API. We can also register I3A callback in vhdr_hal.cpp
#define VHDR_ISP_MGR_READY 1
// ==========================
...
public:
    ...
    */
    //virtual MINT32 GetBufLCSO(android::sp<IImageBuffer>& spBuf) = 0;
