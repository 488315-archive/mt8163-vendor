...
static std::map<enum MemcMode, char*> MEMC_MODE_NAME_INITIALIZER(void)
{
    static std::map<enum MemcMode, char*> m;
...
static map<enum MemcMode, char*> g_strMapMemcMode = MEMC_MODE_NAME_INITIALIZER();
