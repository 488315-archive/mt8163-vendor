...
public:
    ...
    /* plug-in */
    sp<MfllFeatureProperty> m_spProperty;
...
public:
    ...
    /* Avoid accessing race condition */
    mutable Mutex m_lockAccessPtrImgBlended;
    mutable Mutex m_lockAccessPtrImgGolden;

/* implementations */
public:
    virtual enum MfllErr init(const MfllConfig_t *pCfg = NULL);
    virtual enum MfllErr doMfll(MfllConfig cfg);
...
public:
    ...
    enum MfllErr doSingleShot(JOB_VOID);
