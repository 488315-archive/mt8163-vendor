...
generate()
{
    ...
    sp<EffectFrameInfo> dmwFrame = new EffectFrameInfo(
                                                miIndex,
                                                BOKEH_ER_BUF_DMW,
                                                nullptr,
                                                nullptr);
    dmwFrame->setFrameBuffer(mvDepthMapImageBuffer[miIndex]);
    ...
    pRequest->vInputFrameInfo.add(BOKEH_ER_BUF_DMW, dmwFrame);
...
prepareFrame()
{
    ...
    eImgFmt_Y8, DEPTHMAP_SIZE, DEPTHMAP_STRIDES, FULL_RAW_BOUNDARY, 1);
    // MY_S
...
#define LOAD_DEPTH_MAP(NAME, PATH)\
    ...
    //
    LOAD_DEPTH_MAP("DepthMap_0", "/sdcard/vsdof/bokeh_ut/data/DBuf_00000.raw");
    LOAD_DEPTH_MAP("DepthMap_1", "/sdcard/vsdof/bokeh_ut/data/DBuf_00001.raw");
    LOAD_DEPTH_MAP("DepthMap_2", "/sdcard/vsdof/bokeh_ut/data/DBuf_00002.raw");
    LOAD_DEPTH_MAP("DepthMap_3", "/sdcard/vsdof/bokeh_ut/data/DBuf_00003.raw");
    LOAD_DEPTH_MAP("DepthMap_4", "/sdcard/vsdof/bokeh_ut/data/DBuf_00004.raw");
    LOAD_DEPTH_MAP("DepthMap_5", "/sdcard/vsdof/bokeh_ut/data/DBuf_00005.raw");
    LOAD_DEPTH_MAP("DepthMap_6", "/sdcard/vsdof/bokeh_ut/data/DBuf_00006.raw");
    LOAD_DEPTH_MAP("DepthMap_7", "/sdcard/vsdof/bokeh_ut/data/DBuf_00007.raw");
    LOAD_DEPTH_MAP("DepthMap_8", "/sdcard/vsdof/bokeh_ut/data/DBuf_00008.raw");
    LOAD_DEPTH_MAP("DepthMap_9", "/sdcard/vsdof/bokeh_ut/data/DBuf_00009.raw");
