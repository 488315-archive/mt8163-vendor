    ...
    SmartImageBuffer& dmbg)
{
    ...
    if(mParams.scenario == FRAME_SCENARIO_PREVIEW ||
        mParams.scenario == FRAME_SCENARIO_RECORD)
    {
        // set input frame
        ...
        if(mParams.scenario == FRAME_SCENARIO_RECORD)
        {
    ...
    else if(mParams.scenario == FRAME_SCENARIO_CAPTURE)
    {
        // set input frame
...
preareInputData()
{
    ...
    eImgFmt_Y8, DMBG_SIZE, DMBG_STRIDES, FULL_RAW_BOUNDARY, 1);
    // main image
