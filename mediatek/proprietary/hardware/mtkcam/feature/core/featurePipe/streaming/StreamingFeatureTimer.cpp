...
MVOID StreamingFeatureTimer::print(MUINT32 requestNo)
{
    ...
    MY_LOGD("Frame timer [#%5d][t%4d][a%4d/%4d][h%4d][e%4d][f%4d][v%4d][g%4d/%4d][m%4d][b%4d/%4d]",
            requestNo, total, p2aEnque, p2a, helper, eis, fd, vfb, gpuWarp, gpu, mdp, p2bEnque, p2b);
