...
#include <v3/pipeline/IPipelineNode.h> // IPipelineNode
#include <v3/stream/IStreamInfo.h> // IImageStreamInfo

/* declare datatype, the symbol is located at aaa_hal_common.h */
namespace NS3Av3 {
...
public:
     ...
     */
    static android::sp<MFCNode> createInstance(void);
