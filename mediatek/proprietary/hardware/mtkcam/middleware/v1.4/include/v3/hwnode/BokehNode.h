...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
         ...
         * This image is processed by DepthMapNode and is output by WMF.
         * The width and the height of DMW is fixed and image is (240, 135).
         */
        android::sp<IImageStreamInfo> pInHalImageDMW;
