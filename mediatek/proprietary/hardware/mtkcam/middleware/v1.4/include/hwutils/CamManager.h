...
public:     ////                    Operations.
    ...
    void                        incPreviewDevice(int32_t openId);

    void                        decPreviewDevice(int32_t openId);

    int32_t                     getFirstPreviewId() const;
...
private:
    ...
    bool                                mbAvailable;
    bool                                mbStereo;
    Vector<int32_t>                     mvOpenId;
    Vector<int32_t>                     mvPreviewId;
