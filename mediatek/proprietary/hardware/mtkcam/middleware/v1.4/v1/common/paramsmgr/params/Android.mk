...
LOCAL_SRC_FILES += ./extern.cpp \
                   ./ParamsManagerImp.cpp \
                   ./v3/ParamsManagerV3Imp.cpp \
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/middleware/common/v1/common/paramsmgr
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_3A_VERSION)/flash_mgr
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/aaa/source/$(MTKCAM_3A_VERSION)
...
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/v1/common/paramsmgr
#
