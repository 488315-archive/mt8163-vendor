...
#include <feature/include/common/pip/pip_hal.h>   // For PIP Hal GetMaxFrameRate().
...
#include <vhdr/1.0/vhdr_helper.h>
/******************************************************************************
*
*******************************************************************************/
...
updateBestFocusStep() const
{
    ...
    IHal3A* p3AHal = IHal3A::createInstance(IHal3A::E_Camera_3,getOpenId(),PARAM_NAME);
    if ( ! p3AHal )
    {
