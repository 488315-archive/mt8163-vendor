...
LOCAL_C_INCLUDES += \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/isp_tuning \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/aaa \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/cgen/inc \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/cgen/cfgfileinc \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/imgsensor \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/kernel/imgsensor/inc \
    $(MTK_MTKCAM_PLATFORM)/hal/inc/debug_exif/aaa \
    $(MTK_MTKCAM_PLATFORM)/hal/inc/debug_exif/cam \
...
LOCAL_C_INCLUDES += \
    ...
    $(MTK_MTKCAM_PLATFORM)/hal/inc \
    $(MTK_MTKCAM_PLATFORM)/hal/inc/aaa \
