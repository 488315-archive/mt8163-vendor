...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/include
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)/kernel/imgsensor/inc
LOCAL_C_INCLUDES += $(MTK_PATH_COMMON)/kernel/imgsensor/inc
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/kernel/imgsensor/inc
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/camera_feature
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/isp_tuning
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/camera
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/aaa
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/debug_exif/aaa
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/debug_exif/cam
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/inc/mtkcam
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/core/featureio/drv/inc
#LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hardware
...
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/camera/inc
LOCAL_C_INCLUDES += $(MTK_PATH_CUSTOM_PLATFORM)/hal/camera_3a/inc
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/camera_3a/inc
