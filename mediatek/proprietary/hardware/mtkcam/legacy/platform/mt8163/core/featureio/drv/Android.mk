...
LOCAL_C_INCLUDES += \
  ...
  $(TOP)/$(MTK_MTKCAM_PLATFORM)/hal/camera_3a \
  $(MTK_MTKCAM_PLATFORM)/kernel/imgsensor/inc \
  $(MTK_MTKCAM_PLATFORM)/hal/inc/aaa \
  $(MTK_MTKCAM_PLATFORM)/hal/inc \
  $(MTK_MTKCAM_PLATFORM)/hal/camera \
  $(MTK_MTKCAM_PLATFORM)/kernel/flashlight/inc \
  $(MTK_MTKCAM_PLATFORM)/kernel/lens/inc \
