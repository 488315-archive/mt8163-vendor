...
#define EIS_LOG_R(fmt, arg...)    ALOGD("[%s][R]" fmt, __func__, ##arg)
#define EIS_INF_R(fmt, arg...)    ALOGI("[%s][R]" fmt, __func__, ##arg)
#define EIS_WRN_R(fmt, arg...)    ALOGW("[%s][R] WRN(%5d):" fmt, __func__, __LINE__, ##arg)
#define EIS_ERR_R(fmt, arg...)    ALOGE("[%s][R] %s ERROR(%5d):" fmt, __func__,__FILE__, __LINE__, ##arg)
