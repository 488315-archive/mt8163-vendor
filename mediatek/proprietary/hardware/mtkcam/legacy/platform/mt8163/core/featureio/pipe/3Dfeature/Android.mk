...
LOCAL_C_INCLUDES += \
     ...
     $(TOP)/$(MTK_MTKCAM_PLATFORM)/core/featureio/pipe/3Dfeature/mav \
     $(TOP)/$(MTK_MTKCAM_PLATFORM)/core/featureio/pipe/3Dfeature/pano3d \
     ...
     $(TOP)/$(MTK_MTKCAM_PLATFORM)/include/mtkcam/algorithm/libpano3d \
     $(TOP)/$(MTK_MTKCAM_PLATFORM)/include/mtkcam/algorithm/libutility \
	 $(TOP)/$(MTK_MTKCAM_PLATFORM)/mtkcam/inc/featureio \
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hardware/include/
