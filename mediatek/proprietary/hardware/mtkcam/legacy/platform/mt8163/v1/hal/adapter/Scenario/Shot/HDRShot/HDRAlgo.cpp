...
do_CroppedPostviewResize(void)
{
    ...
    MY_DBG("[do_CroppedPostviewResize] ---- mTestMode = %d, mPostviewFormat = %d ", mTestMode, mPostviewFormat);    
    if (mPostviewFormat == 0)
    {
        mPostviewFormat = eImgFmt_YV12;
        MY_DBG("[do_CroppedPostviewResize] ---- mPostviewFormat = %d ", mPostviewFormat);    
    }
