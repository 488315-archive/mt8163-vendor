...
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/inc/isp_tuning

#LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/D2/inc/debug_exif/aaa
LOCAL_C_INCLUDES += $(MTK_MTKCAM_PLATFORM)/hal/inc/debug_exif/cam
#
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/hardware/mtkcam/core/featureio/pipe/aaa/ae_mgr
#
LOCAL_C_INCLUDES += \
    $(TOP)/$(MTK_MTKCAM_PLATFORM)/core/featureio/pipe/aaa/isp_tuning \
    $(MTK_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning \
    $(MTK_MTKCAM_PLATFORM)/hal/inc/isp_tuning \
