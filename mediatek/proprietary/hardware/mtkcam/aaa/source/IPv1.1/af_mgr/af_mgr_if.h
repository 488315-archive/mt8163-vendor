...
public:
    ...
    MRESULT doPDVC(MINT32 i4SensorDev, MVOID *ptrInVCData);
    MRESULT doPDO(MINT32 i4SensorDev, MVOID *ptrInPDOData);
    ...
    MVOID SetCurFrmNum(MINT32 i4SensorDev, MUINT32 i4FrmNum);
