...
setAEInfo(AE_INFO_T const &rAEInfo)
{
    ...
    EIndex_ISO_T const eIdx_ISO = m_pIspTuningCustom->map_ISO_value_to_index(rAEInfo.u4RealISOValue, m_rIspCamInfo.eIspProfile);
                                                                              ...
                                                                              || checkParamChange(m_rIspCamInfo.rAEInfo.i4HdrSeg, rAEInfo.i4HdrSeg))
    {
        ...
        MY_LOG_IF(m_bDebugEnable, "[+m_rIspCamInfo.rAEInfo.i4HdrSeg](old, new)=(%d, %d)", m_rIspCamInfo.rAEInfo.i4HdrSeg, rAEInfo.i4HdrSeg);
    }
...
getIspGamma(MUINT32* pIspGamma, MBOOL* pEnable) const
{
    ...
    *pEnable = ISP_MGR_GGM_T::getInstance(m_eSensorDev).isLNREnable();
