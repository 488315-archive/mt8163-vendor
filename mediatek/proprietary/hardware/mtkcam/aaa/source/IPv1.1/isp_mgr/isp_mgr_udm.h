...
private:
    ...
    enum
    {
       ...
       ERegInfo_DIP_X_UDM_TILE_EDGE,
       ERegInfo_DIP_X_UDM_DSL,
       ERegInfo_DIP_X_UDM_SPARE_1,
       ERegInfo_DIP_X_UDM_SPARE_2,
       ERegInfo_DIP_X_UDM_SPARE_3,
       ERegInfo_NUM
    };
...
protected:
        ...
        , m_u4StartAddr(REG_ADDR_P2(DIP_X_UDM_INTP_CRS))       
    {
        ...
        INIT_REG_INFO_ADDR_P2(DIP_X_UDM_TILE_EDGE);       
        INIT_REG_INFO_ADDR_P2(DIP_X_UDM_DSL);        
        INIT_REG_INFO_ADDR_P2(DIP_X_UDM_SPARE_1);    
        INIT_REG_INFO_ADDR_P2(DIP_X_UDM_SPARE_2);   
        INIT_REG_INFO_ADDR_P2(DIP_X_UDM_SPARE_3);  
    }
