...
get(ISP_NVRAM_OBC_T& rParam)
{
    GET_REG_INFO(DIP_X_OBC2_OFFST0, offst0);
    GET_REG_INFO(DIP_X_OBC2_OFFST1, offst1);
    GET_REG_INFO(DIP_X_OBC2_OFFST2, offst2);
    GET_REG_INFO(DIP_X_OBC2_OFFST3, offst3);
    GET_REG_INFO(DIP_X_OBC2_GAIN0, gain0);
    GET_REG_INFO(DIP_X_OBC2_GAIN1, gain1);
    GET_REG_INFO(DIP_X_OBC2_GAIN2, gain2);
    GET_REG_INFO(DIP_X_OBC2_GAIN3, gain3);
