...
{
#if 1
    MUINT32 BlockNumH = m_u4BlockNumW;
    MUINT32 BlockNumW = m_u4BlockNumH;
...
{
    MY_LOG("[AEconfig] u4NumW/u4NumH/bHDR/bOverCnt/bTSF/bPixel/thr/shift = %d/%d/%d/%d/%d/%d/%d/%d -> %d/%d/%d/%d/%d/%d/%d/%d \n",
