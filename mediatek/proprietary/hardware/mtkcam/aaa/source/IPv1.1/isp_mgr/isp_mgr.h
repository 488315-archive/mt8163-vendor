...
#define REG_ADDR_P1(reg)\
    ((MUINT32)((MUINTPTR)&getIspRegP1()->reg) - (MUINTPTR)getIspRegP1())

#define REG_ADDR_P2(reg)\
    ((MUINT32)((MUINTPTR)&getIspRegP2()->reg) - (MUINTPTR)getIspRegP2())
...
protected:
     ...
     , m_eSensorDev(eSensorDev)
    {
        ...
        if (m_eSensorDev == ESensorDev_Main) {
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Denoise, eSoftwareScenario_Main_Normal_Stream);
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_zHDR_Preview, eSoftwareScenario_Main_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_zHDR_Video, eSoftwareScenario_Main_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_zHDR_Capture, eSoftwareScenario_Main_Normal_Stream);
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_zHDR_Preview, eSoftwareScenario_Sub_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_zHDR_Video, eSoftwareScenario_Sub_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_zHDR_Capture, eSoftwareScenario_Sub_Normal_Stream);
...
protected:
    ...
    getIspRegP1() const
    {
        return reinterpret_cast<cam_reg_t*> (
            IspDrvMgr::getInstance().getIspReg(ISPDRV_MODE_ISP_CAMA)
        );
    }
    ...
    getIspRegP2() const
    {
        return reinterpret_cast<dip_x_reg_t*> (
            IspDrvMgr::getInstance().getIspReg(ISPDRV_MODE_ISP_DIP)
        );
    }
