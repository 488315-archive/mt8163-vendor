...
protected:
        ...
        , m_u4StartAddr(REG_ADDR_P2(DIP_X_MFB_LL_CON2))
    {
        ...
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_CON); // 0x0968
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON1); // 0x096C
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON2); // 0x0970
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON4); // 0x0974
    }
