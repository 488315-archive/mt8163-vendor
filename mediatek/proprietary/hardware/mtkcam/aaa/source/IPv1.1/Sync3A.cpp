...
syncAeInit()
{
    ...
    rAEInitData.main_param.syncAECamType = BAYER_SENSOR;    // todo
    rAEInitData.sub_param.syncAECamType = BAYER_SENSOR;      // todo
...
syncAeMain()
{
    ...
    rAeSyncInput.main_ch.aao_buffer_info.pAEStatisticBuf = NULL; // reinterpret_cast<MVOID *>(IAAOBufMgr::getInstance().getCurrHwBuf(m_i4Master));
    rAeSyncInput.main_ch.aao_buffer_info.buf_line_size = 0;     // todo
    ...
    rAeSyncInput.sub_ch.aao_buffer_info.pAEStatisticBuf = NULL; //reinterpret_cast<MVOID *>(IAAOBufMgr::getInstance().getCurrHwBuf(m_i4Slave));
    rAeSyncInput.sub_ch.aao_buffer_info.buf_line_size = 0;                      // todo
