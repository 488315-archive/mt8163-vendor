...
#define MAX_FILE_PRE_PATH_LEN 50
static char gCreateDir[MAX_FILE_PATH_LEN] = "nvcfg/camera";
static char gFilePath[CAMERA_DATA_TYPE_NUM][MAX_FILE_PRE_PATH_LEN]=
{
    "nvcfg/camera/nv_isp",
    "nvcfg/camera/nv_3a",
    "nvcfg/camera/nv_shading",
    "nvcfg/camera/nv_lens",
    "nvcfg/camera/nv_pline",
    "nvcfg/camera/nv_strobe",
    "nvcfg/camera/nv_tsf",
    "nvcfg/camera/nv_geometry",
    "nvcfg/camera/nv_feature",
    "nvcfg/camera/nv_af_calibration",
    "nvcfg/camera/nv_flash_calibration",
    "nvcfg/camera/nv_version",
};
...
static int writeNv(int dev, int id, void* buf)
{
    ...
    {
        int ret;
        ret = mkdir("/nvcfg/camera", S_IRWXU | S_IRWXG | S_IXOTH);
