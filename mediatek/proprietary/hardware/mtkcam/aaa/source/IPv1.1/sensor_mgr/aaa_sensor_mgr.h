...
//Will be modified
#include <drv/include/mt6797/Sen/hwsync_drv.h>
namespace NS3Av3
{
...
public:
    ...
    MRESULT setStereoFrameSyncExpAndFps(MINT32 i4SensorDev,MUINT32 i4ExpTime ,MINT32 i4Fps);
    MRESULT updateStereoFrameSyncFps(MINT32 i4SensorDev,MUINT32 i4ExpTimeMain,MUINT32 i4ExpTimeMain2);
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Data member
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    ...
    MINT32 m_i4FrameSyncMainFps;
    MINT32 m_i4FrameSyncMain2Fps;
};
