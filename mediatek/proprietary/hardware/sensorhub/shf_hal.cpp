...
void shf_add_con_gesture(uint8_t gesture, uint8_t cgesture) {
    uint8_t sid = session_id_create();
    uint8_t buffer[SHF_AP_BUFFER_BYTES] = {SHF_AP_ADD_CON_GESTURE, sid, gesture, cgesture};
    //ALOGD("shf_communicator_add_con_gesture: gesture=%d, cgesture=%d sid=%d +", gesture, cgesture, sid);
    status_t status = shf_communicator_send_message(SHF_DEVICE_SCP, (void*)buffer, 4);
}

void shf_cancel_con_gesture(uint8_t gesture, uint8_t cgesture) {
    uint8_t sid = session_id_create();
    uint8_t buffer[SHF_AP_BUFFER_BYTES] = {SHF_AP_CANCEL_CON_GESTURE, sid, gesture, cgesture};
    //ALOGD("shf_communicator_add_con_gesture: gesture=%d, cgesture=%d sid=%d +", gesture, cgesture, sid);
    status_t status = shf_communicator_send_message(SHF_DEVICE_SCP, (void*)buffer, 4);
}
...
bool shf_data_valids[] = {
    ...
    false, // 49
    true, //SHF_DATA_INDEX_AUDIO_VALUE 50
    true, //SHF_DATA_INDEX_AUDIO_TIME 51
    false, // 52
    true, //SHF_DATA_INDEX_NOISE_LEVEL_VALUE 53
    true, //SHF_DATA_INDEX_NOISE_LEVEL_TIME 54
    false, // 55
    true, //SHF_DATA_INDEX_FREE_FALL_VALUE 56
    true, //SHF_DATA_INDEX_FREE_FALL_TIME 57
    false, // 58
    true, //SHF_DATA_INDEX_ACTIVITY_WALKING 59
    true, //SHF_DATA_INDEX_ACTIVITY_RUNNING 60
    true, //SHF_DATA_INDEX_ACTIVITY_CLIMBING 61
    false, //reserved for activity 62
    false, //reserved for activity 63
    true, //SHF_DATA_INDEX_TAP_VALUE 64
    true, //SHF_DATA_INDEX_TAP_TIME 65
    false, //66
    true, //SHF_DATA_INDEX_TWIST_VALUE 67
    true, //SHF_DATA_INDEX_TWIST_TIME 68
    false, //69
    true, //SHF_DATA_INDEX_SNAPSHOT_VALUE 70
    true, //SHF_DATA_INDEX_SNAPSHOT_TIME 71
    false, //72
    true, //SHF_DATA_INDEX_PDR_X 73
    true, //SHF_DATA_INDEX_PDR_Y 74
    true, //SHF_DATA_INDEX_PDR_Z 75
    true, //SHF_DATA_INDEX_PDR_TIME 76
    false, //77
};
