...
//    mStreamAttributeTarget.audio_format = AUDIO_FORMAT_PCM_16_BIT;
    ...
    {
        mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Hdmi_Display_Switch"), "SLIMPORT");
    }
    else // MHL
    {
        mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Hdmi_Display_Switch"), "MHL");
    }
