...
void RpCdmaNwRatSwitchHandler::requestSetPreferredNetworkType(const int prefNwType, const sp<RfxMessage>& message) {
    RpBaseNwRatSwitchHandler::requestSetPreferredNetworkType(RADIO_TECH_GROUP_C2K, prefNwType, message);
}
