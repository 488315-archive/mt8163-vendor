...
bool RfxController::requestToRild(const sp<RfxMessage>& message) {
    int id = message->getId();
    if (id == RIL_LOCAL_REQUEST_OEM_HOOK_ATCI_INTERNAL) {
    ...
    return RFX_OBJ_GET_INSTANCE(RfxRilAdapter)->requestToRild(message);
}
