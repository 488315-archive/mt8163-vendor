...
{RIL_UNSOL_CDMA_CARD_TYPE, responseInts, WAKE_PARTIAL},
//IMS
...
// M: IMS/EPDG start
{RIL_UNSOL_SETUP_DATA_CALL_RESPONSE, responseDataCallList, WAKE_PARTIAL},
// M: IMS/EPDG end
/// M: USSI URC commands @{
...
{RIL_UNSOL_VIA_GPS_EVENT, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_VIA_NETWORK_TYPE_CHANGE, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_CDMA_PLMN_CHANGED, responseStrings, WAKE_PARTIAL},
{RIL_UNSOL_VIA_INVALID_SIM_DETECTED, responseVoid, WAKE_PARTIAL},
{RIL_UNSOL_ENG_MODE_NETWORK_INFO, responseStrings, WAKE_PARTIAL},
{RIL_UNSOL_RESPONSE_DATA_NETWORK_TYPE_CHANGED, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_LTE_EARFCN_INFO, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_CDMA_IMSI_READY, responseVoid, WAKE_PARTIAL},
{RIL_UNSOL_CDMA_SIGNAL_FADE, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_CDMA_TONE_SIGNALS, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_NETWORK_EXIST, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_MODULATION_INFO, responseInts, WAKE_PARTIAL},
{RIL_UNSOL_NETWORK_EVENT, responseInts, WAKE_PARTIAL},
// M: MBIM
{RIL_UNSOL_MBIM_RESPONSE, responseDataCallList, WAKE_PARTIAL},
