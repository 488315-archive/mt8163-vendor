...
extern void switchMuxPath();
extern void openChannelFds();
extern void sendRadioCapabilityDoneIfNeeded();
/// M: SVLTE solution2 modification. @{
...
extern int isVsimUrc(const char *s);
extern void updatePhoneIdToMDIdProperty(RIL_SOCKET_ID rid);
extern int isEnableModulationReport();
